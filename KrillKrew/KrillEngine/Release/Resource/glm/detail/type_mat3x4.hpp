...
namespace glm {
template <typename T, precision P = defaultp> struct tmat3x4 {
...
public:
  ...
  template <precision Q> GLM_FUNC_DECL tmat3x4(tmat3x4<T, Q> const &m);

  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR explicit tmat3x4(ctor);
  GLM_FUNC_DECL explicit tmat3x4(T scalar);
  GLM_FUNC_DECL tmat3x4(T x0, T y0, T z0, T w0, T x1, T y1, T z1, T w1, T x2,
                        T y2, T z2, T w2);
  ...
  GLM_FUNC_DECL tmat3x4(X1 x1, Y1 y1, Z1 z1, W1 w1, X2 x2, Y2 y2, Z2 z2, W2 w2,
  ...
  template <typename U> GLM_FUNC_DECL tmat3x4<T, P> &operator+=(U s);
  template <typename U>
  GLM_FUNC_DECL tmat3x4<T, P> &operator+=(tmat3x4<U, P> const &m);
  template <typename U> GLM_FUNC_DECL tmat3x4<T, P> &operator-=(U s);
  template <typename U>
...
template <typename T, precision P>
GLM_FUNC_DECL typename tmat3x4<T, P>::col_type
operator*(tmat3x4<T, P> const &m, typename tmat3x4<T, P>::row_type const &v);

template <typename T, precision P>
GLM_FUNC_DECL typename tmat3x4<T, P>::row_type
operator*(typename tmat3x4<T, P>::col_type const &v, tmat3x4<T, P> const &m);
