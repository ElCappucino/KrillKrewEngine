...
public:
  ...
  template <precision Q> GLM_FUNC_DECL tmat3x3(tmat3x3<T, Q> const &m);

  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR explicit tmat3x3(ctor);
  GLM_FUNC_DECL explicit tmat3x3(T scalar);
  GLM_FUNC_DECL tmat3x3(T x0, T y0, T z0, T x1, T y1, T z1, T x2, T y2, T z2);
  ...
  GLM_FUNC_DECL tmat3x3(X1 x1, Y1 y1, Z1 z1, X2 x2, Y2 y2, Z2 z2, X3 x3, Y3 y3,
                        Z3 z3);
  ...
  template <typename U> GLM_FUNC_DECL tmat3x3<T, P> &operator+=(U s);
  template <typename U>
  GLM_FUNC_DECL tmat3x3<T, P> &operator+=(tmat3x3<U, P> const &m);
  template <typename U> GLM_FUNC_DECL tmat3x3<T, P> &operator-=(U s);
  template <typename U>
...
template <typename T, precision P>
GLM_FUNC_DECL typename tmat3x3<T, P>::col_type
operator*(tmat3x3<T, P> const &m, typename tmat3x3<T, P>::row_type const &v);

template <typename T, precision P>
GLM_FUNC_DECL typename tmat3x3<T, P>::row_type
operator*(typename tmat3x3<T, P>::col_type const &v, tmat3x3<T, P> const &m);
