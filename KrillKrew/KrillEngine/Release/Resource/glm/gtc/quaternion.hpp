...
#pragma GCC diagnostic pop
  ...
  GLM_FUNC_DECL GLM_CONSTEXPR tquat(T const &w, T const &x, T const &y,
                                    T const &z);
...
/// @see gtc_quaternion
template <typename T, precision P>
GLM_FUNC_DECL tquat<T, P> slerp(tquat<T, P> const &x, tquat<T, P> const &y,
                                T a);
...
/// @see gtc_quaternion
template <typename T, precision P>
GLM_FUNC_DECL tquat<T, P> rotate(tquat<T, P> const &q, T const &angle,
...
/// @see gtc_quaternion
template <typename T, precision P>
GLM_FUNC_DECL tvec4<bool, P> lessThan(tquat<T, P> const &x,
                                      tquat<T, P> const &y);
...
/// @see gtc_quaternion
template <typename T, precision P>
GLM_FUNC_DECL tvec4<bool, P> lessThanEqual(tquat<T, P> const &x,
                                           tquat<T, P> const &y);
...
/// @see gtc_quaternion
template <typename T, precision P>
GLM_FUNC_DECL tvec4<bool, P> greaterThan(tquat<T, P> const &x,
                                         tquat<T, P> const &y);
...
/// @see gtc_quaternion
template <typename T, precision P>
GLM_FUNC_DECL tvec4<bool, P> greaterThanEqual(tquat<T, P> const &x,
                                              tquat<T, P> const &y);
...
/// @see gtc_quaternion
template <typename T, precision P>
GLM_FUNC_DECL tvec4<bool, P> notEqual(tquat<T, P> const &x,
                                      tquat<T, P> const &y);
