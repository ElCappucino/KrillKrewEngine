...
template <typename T, precision P = defaultp> struct tdualquat {
  ...
  GLM_FUNC_DECL tdualquat<T, P> &
  operator=(tdualquat<T, P> const &m) GLM_DEFAULT;
...
template <typename T, precision P>
GLM_FUNC_DECL tvec3<T, P> operator*(tdualquat<T, P> const &q,
                                    tvec3<T, P> const &v);
...
template <typename T, precision P>
GLM_FUNC_DECL tvec4<T, P> operator*(tdualquat<T, P> const &q,
                                    tvec4<T, P> const &v);
