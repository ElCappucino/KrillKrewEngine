...
void EntityObject::SetSpriteInfo(SpritesheetInfo info) {
  ...
  spriteRenderer->SetSpriteInfo(info.spritewidth, info.spriteheight,
...
Collider *EntityObject::GetCollider() { return collider; }
...
void EntityObject::SetAnimationSprite(AnimationState state,
