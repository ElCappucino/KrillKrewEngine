...
private:
  ...
  std::array<std::array<UiObject *, 3>, 4>
      playerSkillUIs; // add up to 4 players
  std::array<std::array<TextObject *, 3>, 4>
      playerSkillCooldownTexts; // add up to 4 players
  std::array<std::array<UiObject *, 3>, 4>
      playerSkillCooldownCovers; // add up to 4 players
  ...
  enum TileCollapseDirection { Down, Right, Up, Left };
  ...
  // Pause Menu
  enum PauseMenuButton { Resume = 0, Option, MainMenu };

  // YesNo Menu
  enum YesNoButton { Yes = 0, No };

  // Option Button
  enum OptionButton { Display = 0, MasterVolume, SFXVolume, BGMVolume };

  // Volume Button
  enum VolumeButton { Knob = 0, Box };
  ...
  std::map<int, std::pair<int, int>> blob_lookup_table = {
      ...
      {666, {1, 1}},  {777, {2, 1}},  {888, {3, 1}},  {999, {4, 1}},

      {16, {1, 2}},   {17, {2, 2}},   {1, {3, 2}},    {0, {4, 2}},

      {20, {1, 3}},   {21, {2, 3}},   {5, {3, 3}},    {4, {4, 3}},

      {84, {1, 4}},   {85, {2, 4}},   {69, {3, 4}},   {68, {4, 4}},

      {80, {1, 5}},   {81, {2, 5}},   {65, {3, 5}},   {64, {4, 5}},

      {213, {1, 6}},  {29, {2, 6}},   {23, {3, 6}},   {117, {4, 6}},

      {92, {1, 7}},   {127, {2, 7}},  {223, {3, 7}},  {71, {4, 7}},

      {116, {1, 8}},  {253, {2, 8}},  {247, {3, 8}},  {197, {4, 8}},

      {87, {1, 9}},   {113, {2, 9}},  {209, {3, 9}},  {93, {4, 9}},

      {28, {1, 10}},  {31, {2, 10}},  {95, {3, 10}},  {7, {4, 10}},

      {125, {1, 11}}, {119, {2, 11}}, {255, {3, 11}}, {199, {4, 11}},

      {124, {1, 12}}, {256, {2, 12}}, // blank
      {221, {3, 12}}, {215, {4, 12}},

      {112, {1, 13}}, {245, {2, 13}}, {241, {3, 13}}, {193, {4, 13}},
  };
  ...
  int abilityId[3];
  OrthographicValue
      targetSceneProjection; // use for lerping between the current projection
                             // and this (target projection).
  Camera camera;
  Timer *timer;
...
public:
  ...
  void
  TileImport(std::array<std::array<int, MAP_WIDTH>, MAP_HEIGHT> &TileBuffer,
             std::string fileName);
