...
GizmosObject *Collider::GetGizmos() { return gizmos; }

glm::vec3 Collider::GetSize() { return size; }

glm::vec3 Collider::GetHalfSize() { return halfSize; }

glm::vec3 Collider::GetPreviousPos() { return previousPos; }
ImageObject *Collider::GetParent() { return parent; }
void Collider::SetPreviousPos(glm::vec3 pos) { previousPos = pos; }

Collider::CollisionType Collider::GetCollisionType() { return collisionType; }
...
void Collider::setColliderSize(glm::vec3 size) { this->size = size; }

glm::vec3 Collider::GetOffset() const { return this->offset; }
