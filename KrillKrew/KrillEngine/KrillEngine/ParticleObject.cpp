...
ParticleObject::ParticleObject() {
  ...
  this->SetSize(this->spriteRenderer->GetSpriteWidth(),
                this->spriteRenderer->GetSpriteHeight());
...
void ParticleObject::UpdateCurrentAnimation() {
  ...
  // KK_CORE_WARN("ParticleObject: Position = {0} {1} {2}", this->pos.x,
...
float ParticleObject::getOrderingLayer() const { return 1000; }
