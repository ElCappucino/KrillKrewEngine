...
void ProjectileObject::SetVelocity(float axisX, float axisY, bool isPositiveX,
                                   bool isPositiveY) {
...
glm::vec3 ProjectileObject::GetVelocity() { return velocity; }
...
Collider *ProjectileObject::GetCollider() { return collider; }
...
PlayerObject *ProjectileObject::GetOwner() { return playerOwner; }

void ProjectileObject::SetCanKnockback(bool isCanKnockback) {
  this->CanKnockback = isCanKnockback;
}

bool ProjectileObject::GetCanKnockback() { return CanKnockback; }
...
ProjectileObject::TypeProjectile ProjectileObject::GetType() { return type; }

void ProjectileObject::SetIsShooting(bool isShooting) {
  this->isShooting = isShooting;
}
bool ProjectileObject::GetIsShooting() { return isShooting; }

void ProjectileObject::SetIsCanStun(bool isCanStun) {
  this->CanStun = isCanStun;
}

bool ProjectileObject::GetIsCanStun() { return CanStun; }
void ProjectileObject::UpdateCurrentAnimation() {

  if (currAnimState == AnimationState::Collide) {
    this->SetVelocity(0, 0, true, true);

    float lastFrame = (GetSpriteRenderer()->GetSheetWidth() /
                       GetSpriteRenderer()->GetSpriteWidth()) -
                      1;
    KK_CORE_WARN("ProjectileObject: lastFrame = {0}", lastFrame);
    KK_CORE_WARN("ProjectileObject: GetSpriteRenderer()->GetColumn() = {0}",
                 GetSpriteRenderer()->GetColumn());
...
void ProjectileObject::SetAnimationSprite(AnimationState state,
...
float ProjectileObject::getOrderingLayer() const { return -2000; }