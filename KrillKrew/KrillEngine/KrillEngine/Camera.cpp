...
{
    return GameEngine::GetInstance()->GetRenderer()->GetOrthovalue().right - GameEngine::GetInstance()->GetRenderer()->GetOrthovalue().left;
}
float Camera::GetCameraHeight()
{
    return GameEngine::GetInstance()->GetRenderer()->GetOrthovalue().top - GameEngine::GetInstance()->GetRenderer()->GetOrthovalue().bottom;
}
