...
public:
  enum TypeProjectile { Fireball = 1, Teleport, Bola, Cleave };

  virtual enum AnimationState { Idle = 1, Collide };
...
public:
  ...
  void SetVelocity(float axisX, float axisY, bool isPositiveX,
                   bool isPositiveY);
  ...
  virtual void SetAnimationSprite(AnimationState state,
