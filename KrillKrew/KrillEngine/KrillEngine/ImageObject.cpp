...
SpriteRenderer *ImageObject::GetSpriteRenderer() { return spriteRenderer; }
...
void ImageObject::SetIsAnimated(bool value) { this->isAnimated = value; }
bool ImageObject::GetIsAnimated() { return isAnimated; }
