...
PlayerHitboxObject::PlayerHitboxObject(PlayerObject *parent) {
  ...
  glm::vec3 attackSize =
      glm::vec3(parent->getSize().x / 4, parent->getSize().y / 4, 0);
  glm::vec3 attackPos =
      glm::vec3(parent->getPos().x + 64.f, parent->getPos().y, 0);
...
PlayerHitboxObject::~PlayerHitboxObject() { parent = nullptr; }
...
Collider *PlayerHitboxObject::GetCollider() { return this->collider; }
