...
//  2024-10-07: OpenGL: Changed default texture sampler to Clamp instead of
//  Repeat/Wrap. 2024-06-28: OpenGL: ImGui_ImplOpenGL2_NewFrame() recreates font
//  texture if it has been destroyed by ImGui_ImplOpenGL2_DestroyFontsTexture().
//  (#7748) 2022-10-11: Using 'nullptr' instead of 'NULL' as per our switch to
//  C++11. 2021-12-08: OpenGL: Fixed mishandling of the ImDrawCmd::IdxOffset
//  field! This is an old bug but it never had an effect until some internal
//  rendering changes in 1.86. 2021-06-29: Reorganized backend to pull data from
//  a single structure to facilitate usage with multiple-contexts (all g_XXXX
//  access changed to bd->XXXX). 2021-05-19: OpenGL: Replaced direct access to
