...
namespace glm {
template <typename T, precision P = defaultp> struct tmat4x2 {
...
public:
  ...
  template <precision Q> GLM_FUNC_DECL tmat4x2(tmat4x2<T, Q> const &m);

  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR explicit tmat4x2(ctor);
  GLM_FUNC_DECL explicit tmat4x2(T scalar);
  GLM_FUNC_DECL tmat4x2(T x0, T y0, T x1, T y1, T x2, T y2, T x3, T y3);
  ...
  GLM_FUNC_DECL tmat4x2(X1 x1, Y1 y1, X2 x2, Y2 y2, X3 x3, Y3 y3, X4 x4, Y4 y4);
  ...
  template <typename U> GLM_FUNC_DECL tmat4x2<T, P> &operator+=(U s);
  template <typename U>
  GLM_FUNC_DECL tmat4x2<T, P> &operator+=(tmat4x2<U, P> const &m);
  template <typename U> GLM_FUNC_DECL tmat4x2<T, P> &operator-=(U s);
  template <typename U>
...
template <typename T, precision P>
GLM_FUNC_DECL typename tmat4x2<T, P>::col_type
operator*(tmat4x2<T, P> const &m, typename tmat4x2<T, P>::row_type const &v);

template <typename T, precision P>
GLM_FUNC_DECL typename tmat4x2<T, P>::row_type
operator*(typename tmat4x2<T, P>::col_type const &v, tmat4x2<T, P> const &m);

template <typename T, precision P>
GLM_FUNC_DECL tmat2x2<T, P> operator*(tmat4x2<T, P> const &m1,
