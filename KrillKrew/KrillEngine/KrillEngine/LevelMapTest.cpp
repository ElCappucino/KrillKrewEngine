...
void LevelMapTest::LevelLoad() {
  ...
  spriteList["Blobtile"] =
      SpritesheetInfo("Blobtile", "../Resource/Texture/blobtile_test_kf1.png",
                      128, 128, 1536, 512);
...
void LevelMapTest::LevelInit() {
  ...
  std::map<int, std::pair<int, int>> blob_lookup_table = {
      {16, {1, 1}},   {17, {2, 1}},   {1, {3, 1}},    {0, {4, 1}},

      {20, {1, 2}},   {21, {2, 2}},   {5, {3, 2}},    {4, {4, 2}},

      {84, {1, 3}},   {85, {2, 3}},   {69, {3, 3}},   {68, {4, 3}},

      {80, {1, 4}},   {81, {2, 4}},   {65, {3, 4}},   {64, {4, 4}},

      {213, {1, 5}},  {29, {2, 5}},   {23, {3, 5}},   {117, {4, 5}},

      {92, {1, 6}},   {127, {2, 6}},  {223, {3, 6}},  {71, {4, 6}},

      {116, {1, 7}},  {253, {2, 7}},  {247, {3, 7}},  {197, {4, 7}},

      {87, {1, 8}},   {113, {2, 8}},  {209, {3, 8}},  {93, {4, 8}},

      {28, {1, 9}},   {31, {2, 9}},   {95, {3, 9}},   {7, {4, 9}},

      {125, {1, 10}}, {119, {2, 10}}, {255, {3, 10}}, {199, {4, 10}},

      {124, {1, 11}}, {256, {2, 11}}, // blank
      {221, {3, 11}}, {215, {4, 11}},

      {112, {1, 12}}, {245, {2, 12}}, {241, {3, 12}}, {193, {4, 12}},
  };
    ...
    for (int j = 0; j < MAP_WIDTH; j++) {
      ...
      if (i == 0 || i == MAP_HEIGHT - 1 || j == 0 || j == MAP_WIDTH - 1 ||
        ...
        if (it != blob_lookup_table.end()) {
          ...
          std::cout << "pair = " << it->second.first << " " << it->second.second
                    << std::endl;
        } else {
      ...
      obj->SetPosition(
          glm::vec3(map_left + (j * 32.f), map_top - (i * 32.f), 0));
...
void LevelMapTest::LevelUpdate() {
  ...
  if (SDL_NumJoysticks() > 0) {
    ...
    printf("Joystick No.1 Triangle: %d Square: %d Cross: %d Circle: %d "
           "Leftstick: %f\n",
...
void LevelMapTest::CameraLerp() {
  // check if the length of horizontal and vertical of projection + (target
  // projection - current projection) * zoomInfo.t is not exceed the minimum and
  // maximum. if not, calculate the lerp of left right bottom top and update
  // using SetDrawArea().
}

void LevelMapTest::TileImport(int TileBuffer[][MAP_WIDTH],
                              std::string fileName) {
...
void LevelMapTest::Movement(float axisX, float axisY, bool isPositiveX,
                            bool isPositiveY) {}