...
float ElasticOut(float t) {
  float output =
      std::sin(-13.0 * (t + 1.0) * 3.14 / 2) * std::pow(2.0, -10.0 * t) + 1.0;
  return output;
}
...
void LevelShowcase::LevelLoad() {
  ...
  spriteList["Prinny"] = SpritesheetInfo(
      "Prinny", "../Resource/Texture/Prinny.png", 538, 538, 538, 538);
  ...
  // Cast
  spriteList["P1_Cast"] =
      SpritesheetInfo("P1_Cast", "../Resource/Texture/Ham/P1_Cast.png", 302,
                      302, 1208, 302, false);
  // Cleave
  spriteList["P1_Cleave_Down"] = SpritesheetInfo(
      "P1_Cleave_Down", "../Resource/Texture/Ham/P1_CleaveDown.png", 402, 402,
      1608, 402, false);
  spriteList["P1_Cleave_Side"] = SpritesheetInfo(
      "P1_Cleave_Side", "../Resource/Texture/Ham/P1_CleaveSide.png", 402, 402,
      1608, 402, false);
  spriteList["P1_Cleave_Up"] =
      SpritesheetInfo("P1_Cleave_Up", "../Resource/Texture/Ham/P1_CleaveUp.png",
                      402, 402, 1608, 402, false);
  // Dash
  spriteList["P1_Dash_Back"] =
      SpritesheetInfo("P1_Dash_Back", "../Resource/Texture/Ham/P1_DashBack.png",
                      302, 302, 906, 302, false);
  spriteList["P1_Dash_Front"] = SpritesheetInfo(
      "P1_Dash_Front", "../Resource/Texture/Ham/P1_DashFront.png", 302, 302,
      906, 302, false);
  spriteList["P1_Dash_Side"] =
      SpritesheetInfo("P1_Dash_Side", "../Resource/Texture/Ham/P1_DashSide.png",
                      302, 302, 906, 302, false);
  // Dead (Temp)
  spriteList["P1_Dead"] =
      SpritesheetInfo("P1_Dead", "../Resource/Texture/Ham/P1_Dead.png", 302,
                      302, 302, 302, false);
  // Hit
  spriteList["P1_Hit"] =
      SpritesheetInfo("P1_Hit", "../Resource/Texture/Ham/P1_Hit.png", 302, 302,
                      906, 302, false);
  // Idle
  spriteList["P1_Idle"] = SpritesheetInfo(
      "P1_Idle", "../Resource/Texture/Ham/P1_Idle.png", 302, 302, 1812, 302);
  // Move
  spriteList["P1_Move_Back"] =
      SpritesheetInfo("P1_Move_Back", "../Resource/Texture/Ham/P1_MoveBack.png",
                      302, 302, 1208, 302);
  spriteList["P1_Move_Front"] = SpritesheetInfo(
      "P1_Move_Front", "../Resource/Texture/Ham/P1_MoveFront.png", 302, 302,
      1208, 302);
  spriteList["P1_Move_Side"] =
      SpritesheetInfo("P1_Move_Side", "../Resource/Texture/Ham/P1_MoveSide.png",
                      302, 302, 1208, 302);
  // Place Trap
  spriteList["P1_Place"] =
      SpritesheetInfo("P1_Place", "../Resource/Texture/Ham/P1_Place.png", 302,
                      302, 1208, 302, false);
  // Smash
  spriteList["P1_Smash_DiagDown"] = SpritesheetInfo(
      "P1_Smash_DiagDown", "../Resource/Texture/Ham/P1_SmashDiagDown.png", 302,
      302, 1208, 302, false);
  spriteList["P1_Smash_DiagUp"] = SpritesheetInfo(
      "P1_Smash_DiagUp", "../Resource/Texture/Ham/P1_SmashDiagUp.png", 302, 302,
      1208, 302, false);
  spriteList["P1_Smash_Down"] = SpritesheetInfo(
      "P1_SmashDown", "../Resource/Texture/Ham/P1_SmashDown.png", 302, 302,
      1208, 302, false);
  spriteList["P1_Smash_Side"] = SpritesheetInfo(
      "P1_Smash_Side", "../Resource/Texture/Ham/P1_SmashSide.png", 302, 302,
      1208, 302, false);
  spriteList["P1_Smash_Up"] =
      SpritesheetInfo("P1_Smash_Up", "../Resource/Texture/Ham/P1_SmashUp.png",
                      302, 302, 1208, 302, false);
  // Stun
  spriteList["P1_Stun"] =
      SpritesheetInfo("P1_Stun", "../Resource/Texture/Ham/P1_Stun.png", 350,
                      350, 700, 350, false);
  ...
  // Cast
  spriteList["P2_Cast"] =
      SpritesheetInfo("P2_Cast", "../Resource/Texture/Byssa/P1_Cast.png", 302,
                      302, 1208, 302, false);
  // Cleave
  spriteList["P2_Cleave_Down"] = SpritesheetInfo(
      "P2_Cleave_Down", "../Resource/Texture/Byssa/P2_CleaveDown.png", 402, 402,
      1608, 402, false);
  spriteList["P2_Cleave_Side"] = SpritesheetInfo(
      "P2_Cleave_Side", "../Resource/Texture/Byssa/P2_CleaveSide.png", 402, 402,
      1608, 402, false);
  spriteList["P2_Cleave_Up"] = SpritesheetInfo(
      "P2_Cleave_Up", "../Resource/Texture/Byssa/P2_CleaveUp.png", 402, 402,
      1608, 402, false);
  // Dash
  spriteList["P2_Dash_Back"] = SpritesheetInfo(
      "P2_Dash_Back", "../Resource/Texture/Byssa/P2_DashBack.png", 302, 302,
      906, 302, false);
  spriteList["P2_Dash_Front"] = SpritesheetInfo(
      "P2_Dash_Front", "../Resource/Texture/Byssa/P2_DashFront.png", 302, 302,
      906, 302, false);
  spriteList["P2_Dash_Side"] = SpritesheetInfo(
      "P2_Dash_Side", "../Resource/Texture/Byssa/P2_DashSide.png", 302, 302,
      906, 302, false);
  // Dead (Temp)
  spriteList["P2_Dead"] =
      SpritesheetInfo("P2_Dead", "../Resource/Texture/Byssa/P2_Dead.png", 302,
                      302, 302, 302, false);
  // Hit
  spriteList["P2_Hit"] =
      SpritesheetInfo("P2_Hit", "../Resource/Texture/Byssa/P2_Hit.png", 302,
                      302, 906, 302, false);
  // Idle
  spriteList["P2_Idle"] = SpritesheetInfo(
      "P2_Idle", "../Resource/Texture/Byssa/P2_Idle.png", 302, 302, 1812, 302);
  // Move
  spriteList["P2_Move_Back"] = SpritesheetInfo(
      "P2_Move_Back", "../Resource/Texture/Byssa/P2_MoveBack.png", 302, 302,
      1208, 302);
  spriteList["P2_Move_Front"] = SpritesheetInfo(
      "P2_Move_Front", "../Resource/Texture/Byssa/P2_MoveFront.png", 302, 302,
      1208, 302);
  spriteList["P2_Move_Side"] = SpritesheetInfo(
      "P2_Move_Side", "../Resource/Texture/Byssa/P2_MoveSide.png", 302, 302,
      1208, 302);
  // Place Trap
  spriteList["P2_Place"] =
      SpritesheetInfo("P2_Place", "../Resource/Texture/Byssa/P2_Place.png", 302,
                      302, 1208, 302, false);
  // Smash
  spriteList["P2_Smash_DiagDown"] = SpritesheetInfo(
      "P2_Smash_DiagDown", "../Resource/Texture/Byssa/P2_SmashDiagDown.png",
      302, 302, 1208, 302, false);
  spriteList["P2_Smash_DiagUp"] = SpritesheetInfo(
      "P2_Smash_DiagUp", "../Resource/Texture/Byssa/P2_SmashDiagUp.png", 302,
      302, 1208, 302, false);
  spriteList["P2_Smash_Down"] = SpritesheetInfo(
      "P2_SmashDown", "../Resource/Texture/Byssa/P2_SmashDown.png", 302, 302,
      1208, 302, false);
  spriteList["P2_Smash_Side"] = SpritesheetInfo(
      "P2_Smash_Side", "../Resource/Texture/Byssa/P2_SmashSide.png", 302, 302,
      1208, 302, false);
  spriteList["P2_Smash_Up"] =
      SpritesheetInfo("P2_Smash_Up", "../Resource/Texture/Byssa/P2_SmashUp.png",
                      302, 302, 1208, 302, false);
  // Stun
  spriteList["P2_Stun"] =
      SpritesheetInfo("P2_Stun", "../Resource/Texture/Byssa/P2_Stun.png", 350,
                      350, 700, 350, false);
  ...
  // Cast
  spriteList["P2_Cast"] =
      SpritesheetInfo("P2_Cast", "../Resource/Texture/Byssa/P2_Cast.png", 302,
                      302, 1208, 302, false);
  // Cleave
  spriteList["P2_Cleave_Down"] = SpritesheetInfo(
      "P2_Cleave_Down", "../Resource/Texture/Byssa/P2_CleaveDown.png", 402, 402,
  ...
  spriteList["P2_Smash_DiagUp"] = SpritesheetInfo(
      ...
      302, 1208, 302, false);
  spriteList["P2_Smash_Down"] = SpritesheetInfo(
      "P2_Smash_Down", "../Resource/Texture/Byssa/P2_SmashDown.png", 302, 302,
      1208, 302, false);
  spriteList["P2_Smash_Side"] = SpritesheetInfo(
      "P2_Smash_Side", "../Resource/Texture/Byssa/P2_SmashSide.png", 302, 302,
      1208, 302, false);
  ...
  // Cast
  spriteList["P3_Cast"] =
      SpritesheetInfo("P3_Cast", "../Resource/Texture/Xoey/P3_Cast.png", 302,
                      302, 1208, 302, false);
  // Cleave
  spriteList["P3_Cleave_Down"] = SpritesheetInfo(
      "P3_Cleave_Down", "../Resource/Texture/Xoey/P3_CleaveDown.png", 402, 402,
      1608, 402, false);
  spriteList["P3_Cleave_Side"] = SpritesheetInfo(
      "P3_Cleave_Side", "../Resource/Texture/Xoey/P3_CleaveSide.png", 402, 402,
      1608, 402, false);
  spriteList["P3_Cleave_Up"] = SpritesheetInfo(
      "P3_Cleave_Up", "../Resource/Texture/Xoey/P3_CleaveUp.png", 402, 402,
      1608, 402, false);
  // Dash
  spriteList["P3_Dash_Back"] = SpritesheetInfo(
      "P3_Dash_Back", "../Resource/Texture/Xoey/P3_DashBack.png", 302, 302, 906,
      302, false);
  spriteList["P3_Dash_Front"] = SpritesheetInfo(
      "P3_Dash_Front", "../Resource/Texture/Xoey/P3_DashFront.png", 302, 302,
      906, 302, false);
  spriteList["P3_Dash_Side"] = SpritesheetInfo(
      "P3_Dash_Side", "../Resource/Texture/Xoey/P3_DashSide.png", 302, 302, 906,
      302, false);
  // Dead (Temp)
  spriteList["P3_Dead"] =
      SpritesheetInfo("P3_Dead", "../Resource/Texture/Xoey/P3_Dead.png", 302,
                      302, 302, 302, false);
  // Hit
  spriteList["P3_Hit"] =
      SpritesheetInfo("P3_Hit", "../Resource/Texture/Xoey/P3_Hit.png", 302, 302,
                      906, 302, false);
  // Idle
  spriteList["P3_Idle"] = SpritesheetInfo(
      "P3_Idle", "../Resource/Texture/Xoey/P3_Idle.png", 302, 302, 1812, 302);
  // Move
  spriteList["P3_Move_Back"] = SpritesheetInfo(
      "P3_Move_Back", "../Resource/Texture/Xoey/P3_MoveBack.png", 302, 302,
      1208, 302);
  spriteList["P3_Move_Front"] = SpritesheetInfo(
      "P3_Move_Front", "../Resource/Texture/Xoey/P3_MoveFront.png", 302, 302,
      1208, 302);
  spriteList["P3_Move_Side"] = SpritesheetInfo(
      "P3_Move_Side", "../Resource/Texture/Xoey/P3_MoveSide.png", 302, 302,
      1208, 302);
  // Place Trap
  spriteList["P3_Place"] =
      SpritesheetInfo("P3_Place", "../Resource/Texture/Xoey/P3_Place.png", 302,
                      302, 1208, 302, false);
  // Smash
  spriteList["P3_Smash_DiagDown"] = SpritesheetInfo(
      "P3_Smash_DiagDown", "../Resource/Texture/Xoey/P3_SmashDiagDown.png", 302,
      302, 1208, 302, false);
  spriteList["P3_Smash_DiagUp"] = SpritesheetInfo(
      "P3_Smash_DiagUp", "../Resource/Texture/Xoey/P3_SmashDiagUp.png", 302,
      302, 1208, 302, false);
  spriteList["P3_Smash_Down"] = SpritesheetInfo(
      "P3_Smash_Down", "../Resource/Texture/Xoey/P3_SmashDown.png", 302, 302,
      1208, 302, false);
  spriteList["P3_Smash_Side"] = SpritesheetInfo(
      "P3_Smash_Side", "../Resource/Texture/Xoey/P3_SmashSide.png", 302, 302,
      1208, 302, false);
  spriteList["P3_Smash_Up"] =
      SpritesheetInfo("P3_Smash_Up", "../Resource/Texture/Xoey/P3_SmashUp.png",
                      302, 302, 1208, 302, false);
  // Stun
  spriteList["P3_Stun"] =
      SpritesheetInfo("P3_Stun", "../Resource/Texture/Xoey/P3_Stun.png", 350,
                      350, 700, 350, false);
  ...
  // Cast
  spriteList["P4_Cast"] =
      SpritesheetInfo("P4_Cast", "../Resource/Texture/Crunk/P4_Cast.png", 302,
                      302, 1208, 302, false);
  // Cleave
  spriteList["P4_Cleave_Down"] = SpritesheetInfo(
      "P4_Cleave_Down", "../Resource/Texture/Crunk/P4_CleaveDown.png", 402, 402,
      1608, 402, false);
  spriteList["P4_Cleave_Side"] = SpritesheetInfo(
      "P4_Cleave_Side", "../Resource/Texture/Crunk/P4_CleaveSide.png", 402, 402,
      1608, 402, false);
  spriteList["P4_Cleave_Up"] = SpritesheetInfo(
      "P4_Cleave_Up", "../Resource/Texture/Crunk/P4_CleaveUp.png", 402, 402,
      1608, 402, false);
  // Dash
  spriteList["P4_Dash_Back"] = SpritesheetInfo(
      "P4_Dash_Back", "../Resource/Texture/Crunk/P4_DashBack.png", 302, 302,
      906, 302, false);
  spriteList["P4_Dash_Front"] = SpritesheetInfo(
      "P4_Dash_Front", "../Resource/Texture/Crunk/P4_DashFront.png", 302, 302,
      906, 302, false);
  spriteList["P4_Dash_Side"] = SpritesheetInfo(
      "P4_Dash_Side", "../Resource/Texture/Crunk/P4_DashSide.png", 302, 302,
      906, 302, false);
  // Dead
  spriteList["P4_Dead"] =
      SpritesheetInfo("P4_Dead", "../Resource/Texture/Crunk/P4_Dead.png", 302,
                      302, 302, 302, false);
  // Hit
  spriteList["P4_Hit"] =
      SpritesheetInfo("P4_Hit", "../Resource/Texture/Crunk/P4_Hit.png", 302,
                      302, 906, 302, false);
  // Idle
  spriteList["P4_Idle"] = SpritesheetInfo(
      "P4_Idle", "../Resource/Texture/Crunk/P4_Idle.png", 302, 302, 1812, 302);
  // Move
  spriteList["P4_Move_Back"] = SpritesheetInfo(
      "P4_Move_Back", "../Resource/Texture/Crunk/P4_MoveBack.png", 302, 302,
      1208, 302);
  spriteList["P4_Move_Front"] = SpritesheetInfo(
      "P4_Move_Front", "../Resource/Texture/Crunk/P4_MoveFront.png", 302, 302,
      1208, 302);
  spriteList["P4_Move_Side"] = SpritesheetInfo(
      "P4_Move_Side", "../Resource/Texture/Crunk/P4_MoveSide.png", 302, 302,
      1208, 302);
  // Place Trap
  spriteList["P4_Place"] =
      SpritesheetInfo("P4_Place", "../Resource/Texture/Crunk/P4_Place.png", 302,
                      302, 1208, 302, false);
  // Smash
  spriteList["P4_Smash_DiagDown"] = SpritesheetInfo(
      "P4_Smash_DiagDown", "../Resource/Texture/Crunk/P4_SmashDiagDown.png",
      302, 302, 1208, 302, false);
  spriteList["P4_Smash_DiagUp"] = SpritesheetInfo(
      "P4_Smash_DiagUp", "../Resource/Texture/Crunk/P4_SmashDiagUp.png", 302,
      302, 1208, 302, false);
  spriteList["P4_Smash_Down"] = SpritesheetInfo(
      "P4_Smash_Down", "../Resource/Texture/Crunk/P4_SmashDown.png", 302, 302,
      1208, 302, false);
  spriteList["P4_Smash_Side"] = SpritesheetInfo(
      "P4_Smash_Side", "../Resource/Texture/Crunk/P4_SmashSide.png", 302, 302,
      1208, 302, false);
  spriteList["P4_Smash_Up"] =
      SpritesheetInfo("P4_Smash_Up", "../Resource/Texture/Crunk/P4_SmashUp.png",
                      302, 302, 1208, 302, false);
  // Stun
  spriteList["P4_Stun"] =
      SpritesheetInfo("P3_Stun", "../Resource/Texture/Crunk/P4_Stun.png", 350,
                      350, 700, 350, false);

  // Item
  spriteList["Bomb"] = SpritesheetInfo(
      "Bomb", "../Resource/Texture/Ability/abi_spr_bomb_projecttile.png", 300,
      300, 1800, 300, true);
  spriteList["Trap"] = SpritesheetInfo(
      "Trap", "../Resource/Texture/Ability/abi_spr_jellyfish_putdown.png", 256,
      256, 4096, 256, false);
  spriteList["TNT"] = SpritesheetInfo(
      "TNT", "../Resource/Texture/Ability/abi_spr_landmine_idle.png", 370, 370,
      740, 370, true);
  spriteList["Teleport"] = SpritesheetInfo(
      "Teleport", "../Resource/Texture/Ability/abi_spr_teleport_projectile.png",
      211, 97, 422, 97, true);
  spriteList["Bola"] = SpritesheetInfo(
      "Bola", "../Resource/Texture/Ability/abi_spr_stun_projecttile.png", 400,
      400, 1600, 400, true);
  spriteList["Cleave"] = SpritesheetInfo(
      "Cleave", "../Resource/Texture/Ability/abi_spr_cleave_side.png", 358, 258,
      1074, 258, true);

  spriteList["Bomb_Explode"] = SpritesheetInfo(
      "Bomb_Explode", "../Resource/Texture/Ability/abi_spr_bomb_explosion.png",
      498, 498, 2490, 498, false);
  spriteList["Landmine_Explode"] = SpritesheetInfo(
      "Landmine_Explode",
      "../Resource/Texture/Ability/abi_spr_landmine_explosion.png", 370, 370,
      2590, 370, false);
  spriteList["Teleport_Explode"] = SpritesheetInfo(
      "Teleport_Explode",
      "../Resource/Texture/Ability/abi_spr_teleport_explosion.png", 250, 250,
      1000, 250, false);
  spriteList["Stun_Explode"] = SpritesheetInfo(
      "Stun_Explode", "../Resource/Texture/Ability/abi_spr_stun_explosion.png",
      400, 400, 1600, 400, false);
  spriteList["Trap_Explode"] = SpritesheetInfo(
      "Trap_Explode",
      "../Resource/Texture/Ability/abi_spr_jellyfish_explosion.png", 332, 332,
      4316, 332, false);

  spriteList["Xoey_UI"] = SpritesheetInfo(
      "Xoey_UI", "../Resource/Texture/xoey.png", 430, 220, 430, 220);
  spriteList["Byssa_UI"] = SpritesheetInfo(
      "Byssa_UI", "../Resource/Texture/byssa.png", 430, 220, 430, 220);
  spriteList["Crunk_UI"] = SpritesheetInfo(
      "Crunk_UI", "../Resource/Texture/crunk.png", 430, 220, 430, 220);
  spriteList["Ham_UI"] = SpritesheetInfo(
      "Ham_UI", "../Resource/Texture/Ham.png", 430, 220, 430, 220);

  spriteList["Player_UI"] = SpritesheetInfo(
      "Player_UI", "../Resource/Texture/Gameplay/UI_GP_PlayerWindow.png", 420,
      116, 1680, 116);
  spriteList["AbilityGameplay_UI"] = SpritesheetInfo(
      "AbilityGameplay_UI",
      "../Resource/Texture/Gameplay/UI_GP_Abilityicon.png", 69, 69, 552, 69);
  spriteList["AbilityCover_UI"] = SpritesheetInfo(
      "AbilityCover_UI",
      "../Resource/Texture/Gameplay/UI_GP_Abilityicon_black.png", 69, 69, 69,
      69);

  spriteList["Blobtile"] = SpritesheetInfo(
      "Blobtile", "../Resource/Texture/tileset_01.png", 128, 128, 1664, 512);

  // Prop
  spriteList["Prop_A"] = SpritesheetInfo(
      "Prop_A", "../Resource/Texture/Props/prop_A.png", 170, 170, 1020, 170);
  spriteList["Prop_B"] = SpritesheetInfo(
      "Prop_B", "../Resource/Texture/Props/prop_B.png", 123, 123, 369, 170);
  spriteList["Prop_C"] = SpritesheetInfo(
      "Prop_C", "../Resource/Texture/Props/prop_C.png", 91, 91, 637, 91);

  spriteList["Tree_A"] = SpritesheetInfo(
      "Tree_A", "../Resource/Texture/Props/prop_spr_CoconutTree_A.png", 300,
      400, 900, 400, true);
  spriteList["Tree_B"] = SpritesheetInfo(
      "Tree_B", "../Resource/Texture/Props/prop_spr_CoconutTree_B.png", 250,
      370, 750, 370, true);

  spriteList["Leaf1_Collapse"] = SpritesheetInfo(
      "Tree_B", "../Resource/Texture/Props/prop_spr_vfx_leaf.png", 200, 200,
      800, 200);
  spriteList["Leaf2_Collapse"] = SpritesheetInfo(
      "Tree_B", "../Resource/Texture/Props/prop_spr_vfx_smallleaf.png", 120,
      120, 480, 120);

  spriteList["CollapseTile"] = SpritesheetInfo(
      "CollapseTile", "../Resource/Texture/Props/prop_spr_vfx_smoke.png", 200,
      200, 800, 200);

  spriteList["DangerSign"] = SpritesheetInfo(
      "DangerSign", "../Resource/Texture/Gameplay/UI_GP_Event_DangerSign.png",
      544, 215, 544, 215);

  spriteList["Pause_BG"] = SpritesheetInfo(
      "Pause_BG", "../Resource/Texture/Menu/Pause/UI_Pause_BG.png", 623, 671,
      623, 671);
  spriteList["Pause_text"] = SpritesheetInfo(
      "Pause_text", "../Resource/Texture/Menu/Pause/UI_Pause_text.png", 300, 70,
      1800, 70);

  spriteList["AreYouSure"] = SpritesheetInfo(
      "AreYouSure", "../Resource/Texture/Are You Sure/UI_AreYouSure_BG.png",
      676, 317, 2028, 317);
  spriteList["AreYouSureYN"] = SpritesheetInfo(
      "AreYouSureYN",
      "../Resource/Texture/Are You Sure/UI_AreYouSure_YesNo.png", 235, 45, 940,
      45);

  spriteList["OptionsBG"] = SpritesheetInfo(
      "OptionsBG", "../Resource/Texture/Pause and Options/UI_Options_BG.png",
      623, 671, 623, 671);
  spriteList["OptionsDisplay"] = SpritesheetInfo(
      "OptionsDisplay",
      "../Resource/Texture/Pause and Options/UI_Options_Display_tab.png", 309,
      50, 1236, 50);
  spriteList["OptionsDisplayDropdown"] =
      SpritesheetInfo("OptionsDisplayDropdown",
                      "../Resource/Texture/Pause and "
                      "Options/UI_Options_Display_tabdropdown.png",
                      300, 94, 600, 94);
  spriteList["OptionsText"] = SpritesheetInfo(
      "OptionsText",
      "../Resource/Texture/Pause and Options/UI_Options_text.png", 183, 25,
      1464, 25);
  spriteList["OptionsVolumeBox"] = SpritesheetInfo(
      "OptionsVolumeBox",
      "../Resource/Texture/Pause and Options/UI_Options_Volume_box.png", 32, 32,
      128, 32);
  spriteList["OptionsVolumeKnob"] = SpritesheetInfo(
      "OptionsVolumeKnob",
      "../Resource/Texture/Pause and Options/UI_Options_Volume_knob.png", 21,
      41, 42, 41);
  spriteList["OptionsVolumeTrack"] = SpritesheetInfo(
      "OptionsVolumeTrack",
      "../Resource/Texture/Pause and Options/UI_Options_Volume_track.png", 406,
      12, 812, 12);
...
void LevelShowcase::InitTile() {
  SDL_GetWindowSize(GameEngine::GetInstance()->GetSDLWindow(), &windowWidth,
                    &windowHeight);
  ...
  for (int i = 0; i < MAP_HEIGHT; i++) {
    for (int j = 0; j < MAP_WIDTH; j++) {
      currentLoadedTile++;
      // KK_CORE_TRACE("Generate Map-----------{0}%", 100.f * currentLoadedTile
      // / totalLoadedTile);
      ...
      if (i == 0 || i == MAP_HEIGHT - 1 || j == 0 || j == MAP_WIDTH - 1) {
        ...
        if (flag == 0) {
          auto lookup_sheet =
              blob_lookup_table_underground.find((int)(surround.to_ulong()));

          if (lookup_sheet != blob_lookup_table_underground.end() &&
              groundTile[checkPosRow][j] != 0) {
          ...
          auto lookup_sheet =
              blob_lookup_table.find((int)(surround.to_ulong()));
      ...
      if (pos.first == 2 && pos.second == 12) {
        ...
        // KK_TRACE("Pos {0}, {1} pos.first = {2} pos.second = {3} ", i, j,
        // pos.first, pos.second);
        TileObject *obj = new TileObject();
        obj->SetTextureWithID(spriteList.find("Blobtile")->second,
                              spriteList.find("Blobtile")->second.textureid);
        ...
        obj->SetPosition(
            glm::vec3(map_left + (j * 126.f), map_top - (i * 126.f), 0));
...
void LevelShowcase::InitProp() {
  ...
  for (int i = 0; i < MAP_HEIGHT; i++) {
    for (int j = 0; j < MAP_WIDTH; j++) {
      currentLoadedTile++;
      // KK_CORE_TRACE("Generate Prop-----------{0}%", 100.f * currentLoadedTile
      // / totalLoadedTile);
      ...
      switch (flag) {
      case 1:
        obj->SetTextureWithID(spriteList.find("Prop_A")->second,
                              spriteList.find("Prop_A")->second.textureid);
        ...
        break;
      case 2:
        obj->SetTextureWithID(spriteList.find("Prop_B")->second,
                              spriteList.find("Prop_B")->second.textureid);
        ...
        break;
      case 3:
        obj->SetTextureWithID(spriteList.find("Prop_C")->second,
                              spriteList.find("Prop_C")->second.textureid);
        ...
        break;
      case 4:
        obj->SetTextureWithID(spriteList.find("Tree_A")->second,
                              spriteList.find("Tree_A")->second.textureid);
        ...
        break;
      case 5:
        obj->SetTextureWithID(spriteList.find("Tree_B")->second,
                              spriteList.find("Tree_B")->second.textureid);
...
void LevelShowcase::LevelInit() {
  ...
  for (auto &info : spriteList) {
    unsigned int texture =
        GameEngine::GetInstance()->GetRenderer()->LoadTexture(
            info.second.texture);
  ...
  p1->SetAnimationSprite(PlayerObject::AnimationState::Idle,
                         spriteList.find("P1_Idle")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::GetHit,
                         spriteList.find("P1_Hit")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::Stun,
                         spriteList.find("P1_Stun")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::FellDown,
                         spriteList.find("P1_Dead")->second);

  p1->SetAnimationSprite(PlayerObject::AnimationState::Move_Side,
                         spriteList.find("P1_Move_Side")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::Move_Back,
                         spriteList.find("P1_Move_Back")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::Move_Front,
                         spriteList.find("P1_Move_Front")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::Cast,
                         spriteList.find("P1_Cast")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::PlaceItem,
                         spriteList.find("P1_Place")->second);

  p1->SetAnimationSprite(PlayerObject::AnimationState::Smash_DiagDown,
                         spriteList.find("P1_Smash_DiagDown")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::Smash_DiagUp,
                         spriteList.find("P1_Smash_DiagUp")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::Smash_Down,
                         spriteList.find("P1_Smash_Down")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::Smash_Side,
                         spriteList.find("P1_Smash_Side")->second);
  p1->SetAnimationSprite(PlayerObject::AnimationState::Smash_Up,
                         spriteList.find("P1_Smash_Up")->second);
  ...
  p1->SetAbility(PlayerObject::AbilityButton::Triangle,
                 static_cast<PlayerObject::Ability>(abilityId[0]));
  p1->SetAbility(PlayerObject::AbilityButton::Circle,
                 static_cast<PlayerObject::Ability>(abilityId[1]));
  p1->SetAbility(PlayerObject::AbilityButton::Cross,
                 static_cast<PlayerObject::Ability>(abilityId[2]));
  p1->SetTextureWithID(spriteList.find("P1_Idle")->second,
                       spriteList.find("P1_Idle")->second.textureid);
  ...
  p2->SetAnimationSprite(PlayerObject::AnimationState::Idle,
                         spriteList.find("P2_Idle")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Stun,
                         spriteList.find("P2_Stun")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::FellDown,
                         spriteList.find("P2_Dead")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::GetHit,
                         spriteList.find("P2_Hit")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Move_Side,
                         spriteList.find("P2_Move_Side")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Move_Back,
                         spriteList.find("P2_Move_Back")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Move_Front,
                         spriteList.find("P2_Move_Front")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Cast,
                         spriteList.find("P2_Cast")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::PlaceItem,
                         spriteList.find("P2_Place")->second);

  p2->SetAnimationSprite(PlayerObject::AnimationState::Smash_DiagDown,
                         spriteList.find("P2_Smash_DiagDown")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Smash_DiagUp,
                         spriteList.find("P2_Smash_DiagUp")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Smash_Down,
                         spriteList.find("P2_Smash_Down")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Smash_Side,
                         spriteList.find("P2_Smash_Side")->second);
  p2->SetAnimationSprite(PlayerObject::AnimationState::Smash_Up,
                         spriteList.find("P2_Smash_Up")->second);
  ...
  p2->SetAbility(PlayerObject::AbilityButton::Triangle,
                 static_cast<PlayerObject::Ability>(abilityId[0]));
  p2->SetAbility(PlayerObject::AbilityButton::Circle,
                 static_cast<PlayerObject::Ability>(abilityId[1]));
  p2->SetAbility(PlayerObject::AbilityButton::Cross,
                 static_cast<PlayerObject::Ability>(abilityId[2]));

  p2->SetTextureWithID(spriteList.find("P2_Idle")->second,
                       spriteList.find("P2_Idle")->second.textureid);
  ...
  p3->SetAnimationSprite(PlayerObject::AnimationState::Idle,
                         spriteList.find("P3_Idle")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Stun,
                         spriteList.find("P3_Stun")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::FellDown,
                         spriteList.find("P3_Dead")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::GetHit,
                         spriteList.find("P3_Hit")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Move_Side,
                         spriteList.find("P3_Move_Side")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Move_Back,
                         spriteList.find("P3_Move_Back")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Move_Front,
                         spriteList.find("P3_Move_Front")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Cast,
                         spriteList.find("P3_Cast")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::PlaceItem,
                         spriteList.find("P3_Place")->second);

  p3->SetAnimationSprite(PlayerObject::AnimationState::Smash_DiagDown,
                         spriteList.find("P3_Smash_DiagDown")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Smash_DiagUp,
                         spriteList.find("P3_Smash_DiagUp")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Smash_Down,
                         spriteList.find("P3_Smash_Down")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Smash_Side,
                         spriteList.find("P3_Smash_Side")->second);
  p3->SetAnimationSprite(PlayerObject::AnimationState::Smash_Up,
                         spriteList.find("P3_Smash_Up")->second);
  ...
  p3->SetAbility(PlayerObject::AbilityButton::Triangle,
                 static_cast<PlayerObject::Ability>(abilityId[0]));
  p3->SetAbility(PlayerObject::AbilityButton::Circle,
                 static_cast<PlayerObject::Ability>(abilityId[1]));
  p3->SetAbility(PlayerObject::AbilityButton::Cross,
                 static_cast<PlayerObject::Ability>(abilityId[2]));
  p3->SetTextureWithID(spriteList.find("P3_Idle")->second,
                       spriteList.find("P3_Idle")->second.textureid);
  ...
  p4->SetAnimationSprite(PlayerObject::AnimationState::Idle,
                         spriteList.find("P4_Idle")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::Stun,
                         spriteList.find("P4_Stun")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::FellDown,
                         spriteList.find("P4_Dead")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::GetHit,
                         spriteList.find("P4_Hit")->second);

  p4->SetAnimationSprite(PlayerObject::AnimationState::Move_Side,
                         spriteList.find("P4_Move_Side")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::Move_Back,
                         spriteList.find("P4_Move_Back")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::Move_Front,
                         spriteList.find("P4_Move_Front")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::Cast,
                         spriteList.find("P4_Cast")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::PlaceItem,
                         spriteList.find("P4_Place")->second);

  p4->SetAnimationSprite(PlayerObject::AnimationState::Smash_DiagDown,
                         spriteList.find("P4_Smash_DiagDown")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::Smash_DiagUp,
                         spriteList.find("P4_Smash_DiagUp")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::Smash_Down,
                         spriteList.find("P4_Smash_Down")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::Smash_Side,
                         spriteList.find("P4_Smash_Side")->second);
  p4->SetAnimationSprite(PlayerObject::AnimationState::Smash_Up,
                         spriteList.find("P4_Smash_Up")->second);
  ...
  p4->SetAbility(PlayerObject::AbilityButton::Triangle,
                 static_cast<PlayerObject::Ability>(abilityId[0]));
  p4->SetAbility(PlayerObject::AbilityButton::Circle,
                 static_cast<PlayerObject::Ability>(abilityId[1]));
  p4->SetAbility(PlayerObject::AbilityButton::Cross,
                 static_cast<PlayerObject::Ability>(abilityId[2]));
  p4->SetTextureWithID(spriteList.find("P4_Idle")->second,
                       spriteList.find("P4_Idle")->second.textureid);
  ...
  for (int i = 0; i < 3; i++) {
    ...
    optionVolumeTrack->SetSpriteInfo(
        spriteList.find("OptionsVolumeTrack")->second);
  ...
  DisplayDropDown->SetSpriteInfo(
      spriteList.find("OptionsDisplayDropdown")->second);
  ...
  for (int i = 0; i < 3; i++) {
    ...
    optionVolumeKnob->SetSpriteInfo(
        spriteList.find("OptionsVolumeKnob")->second);
  ...
  for (int i = 0; i < playerSize; i++) {
    for (int j = 0; j < 3; j++) {
      ...
      playerSkillCooldownTexts[i][j]->loadText("5", SDL_Color{255, 255, 255},
                                               64);
      ...
      playerSkillCooldownCovers[i][j]->SetSpriteInfo(
          spriteList.find("AbilityCover_UI")->second);
  ...
  ImGui_ImplSDL2_InitForOpenGL(GameEngine::GetInstance()->GetSDLWindow(),
                               GameEngine::GetInstance()->GetglContext());
    ...
    if (isVolume) {
      ...
      case VolumeButton::Knob:
        if (currentOptionButton == OptionButton::MasterVolume) {
          ...
          if (volumeBoxList.at(0)->GetSpriteRenderer()->GetColumn() == 0 ||
              volumeBoxList.at(0)->GetSpriteRenderer()->GetColumn() == 1) {
          ...
          if (volumeBoxList.at(1)->GetSpriteRenderer()->GetColumn() == 0 ||
              volumeBoxList.at(1)->GetSpriteRenderer()->GetColumn() == 1) {
          ...
          if (volumeBoxList.at(2)->GetSpriteRenderer()->GetColumn() == 0 ||
              volumeBoxList.at(2)->GetSpriteRenderer()->GetColumn() == 1) {
      ...
      for (int i = 0; i < volumeKnobList.size(); i++) {
        if (i == 0) {
          posX = centerPosX + ((masterVolume * 4.f - 58.f / 0.25f) *
                               camera.GetCameraWidth() / SCREEN_WIDTH);

        } else if (i == 1) {
          posX = centerPosX + ((sfxVolume * 4.f - 58.f / 0.25f) *
                               camera.GetCameraWidth() / SCREEN_WIDTH);
        } else if (i == 2) {
          posX = centerPosX + ((musicVolume * 4.f - 58.f / 0.25f) *
                               camera.GetCameraWidth() / SCREEN_WIDTH);
        }
        posY = centerPosY + ((95 + ((-i - 1) * 100)) *
                             camera.GetCameraHeight() / SCREEN_HEIGHT);
        volumeKnobList.at(i)->SetPosition(glm::vec3(posX, posY, 0));
        volumeKnobList.at(i)->SetSize(
            volumeKnobList.at(i)->GetSpriteRenderer()->GetSpriteWidth() *
                camera.GetCameraWidth() / SCREEN_WIDTH,
            -volumeKnobList.at(i)->GetSpriteRenderer()->GetSpriteHeight() *
                camera.GetCameraHeight() / SCREEN_HEIGHT);
      }
    }
    UpdateInput();
    ...
    for (int i = 0; i < entityObjects.size(); i++) {
      ...
      if (entity == nullptr) {
        ...
        if (entity->GetIsAnimated() &&
            frame % entity->GetSpriteRenderer()->GetFrame() == 0) {
  ...
  if (isStartKrakenEvent) {
    ...
    if (timePerTileCounter > timePerTileKrakenEvent) {
      ...
      case TileCollapseDirection::Down:
        ...
        if (currrentCollapsePosition.y ==
            MAP_HEIGHT - 1 - KrakenEventOffset_bottom) {
      ...
      case TileCollapseDirection::Right:
        ...
        if (currrentCollapsePosition.x ==
            MAP_WIDTH - 1 - KrakenEventOffset_right) {
...
void LevelShowcase::UpdateCountdown() {
  for (TextObject *text : textObjects) {
    ...
    text->SetSize(text_SizeX + ElasticOut(text_t) * maxSizeX,
                  text_SizeY + ElasticOut(text_t) * maxSizeY);
  }
...
void LevelShowcase::UpdateInput() {
  if (SDL_NumJoysticks() > 0) {
    ...
    if (isPause) {
      float axisX =
          Joystick::GetAxis(0, Joystick::Axis::LeftStickHorizontal) / 32768.0f;
      float axisY =
          Joystick::GetAxis(0, Joystick::Axis::LeftStickVertical) / 32768.0f;
      ...
      if (!isPressedInPause && !isAreYouSure && !isOption) {
        ...
        if ((norAxisY > 0.0f && isPositiveY == false) ||
            Joystick::GetButton(0, Joystick::Button::DPAD_Down)) // press down
        {
        ...
        if ((norAxisY < 0.0f && isPositiveY == true) ||
            Joystick::GetButton(0, Joystick::Button::DPAD_Up)) // press up
        {
        ...
        if (abs(norAxisY) < 0.3f && norAxisX < 0.3f &&
            !Joystick::GetButton(0, Joystick::Button::DPAD_Up) &&
            !Joystick::GetButton(0, Joystick::Button::DPAD_Down)) // press down
        {
      ...
      if (!isPressedInPause && isAreYouSure) {
        if ((norAxisX > 0.0f && isPositiveX == true) ||
            Joystick::GetButton(0, Joystick::Button::DPAD_Right)) {
          currentYesNoButton = YesNoButton::No;
        }

        if ((norAxisX < 0.0f && isPositiveX == false) ||
            Joystick::GetButton(0, Joystick::Button::DPAD_Left)) {
          currentYesNoButton = YesNoButton::Yes;
        }
      }

      if (Joystick::GetButtonDown(0, Joystick::Button::Cross) &&
          !isAreYouSure && !isOption) {
      ...
      else if (Joystick::GetButtonDown(0, Joystick::Button::Cross) &&
               isAreYouSure) {
        isAreYouSure = false;
        if (currentYesNoButton == YesNoButton::Yes) {
          GameEngine::GetInstance()->GetStateController()->loadingState =
              GameState::GS_LEVELMAINMENU;
          GameEngine::GetInstance()->GetStateController()->gameStateNext =
              GameState::GS_LEVELLOADING;
        }
          ...
          currentYesNoButton = YesNoButton::No;
               ...
               isOption && !isDisplayDropDown && !isVolume) {
        isAreYouSure = false;
        if (currentOptionButton == OptionButton::Display) {
        ...
        if (DisplayDropDown->GetSpriteRenderer()->GetColumn() == 0) {
          SDL_SetWindowFullscreen(GameEngine::GetInstance()->GetSDLWindow(),
                                  SDL_WINDOW_FULLSCREEN_DESKTOP);
          SDL_GetWindowSize(GameEngine::GetInstance()->GetSDLWindow(),
      ...
      else if (Joystick::GetButtonDown(0, Joystick::Button::Circle) &&
               isAreYouSure) {
        isAreYouSure = false;
        currentYesNoButton = YesNoButton::No;
      }
        ...
        for (int i = 0; i < 3; i++) {
          if (i == currentOptionButton - 1) {
            ...
            if (volumeBoxList.at(i)->GetSpriteRenderer()->GetColumn() == 0 ||
                volumeBoxList.at(i)->GetSpriteRenderer()->GetColumn() == 1) {
        ...
        if ((norAxisY > 0.0f && isPositiveY == false) ||
            Joystick::GetButton(0, Joystick::Button::DPAD_Down)) {
          DisplayDropDown->GetSpriteRenderer()->ShiftTo(0, 1);
        }
      ...
      for (int i = 0; i < playerSize; i++) {
        ...
        float axisX =
            Joystick::GetAxis(i, Joystick::Axis::LeftStickHorizontal) /
            32768.0f;
        float axisY =
            Joystick::GetAxis(i, Joystick::Axis::LeftStickVertical) / 32768.0f;
        float norAxisX = 0;
        float norAxisY = 0;
        ...
        if (norAxisX != 0 || norAxisY != 0) {
          players[i + currentPlayer]->SetCurrentDirection(
              glm::vec2(norAxisX, norAxisY));
        }
        ...
        if (players[i + currentPlayer]->GetIsFell() == false) {
          ...
          if (players[i + currentPlayer]->GetIsKnockback() == false) {
            if (players[i + currentPlayer]->GetIsStun() == true) {
              ...
              players[i + currentPlayer]->SetVelocity(
                  0, 0, isPositiveXOld[i + currentPlayer],
              ...
              players[i + currentPlayer]->SetVelocity(
                  abs(norAxisX), abs(norAxisY), isPositiveX, isPositiveY);
            }
          }
          ...
          if (players[i + currentPlayer]->GetIsAiming()) {
            ...
            if (players[i]->GetHoldingProjectile() ==
                    static_cast<int>(ProjectileObject::Cleave) &&
                players[i]->projectileHoldDuration >= 3) {
              PlayerObject::Ability idAbility = players[i]->GetAbilityByButton(
                  PlayerObject::AbilityButton::Circle);
              if (idAbility == PlayerObject::Ability::Cleave) {
                ShootCleave(i, PlayerObject::AbilityButton::Circle);
              }

              idAbility = players[i]->GetAbilityByButton(
                  PlayerObject::AbilityButton::Cross);
              if (idAbility == PlayerObject::Ability::Cleave) {
                ShootCleave(i, PlayerObject::AbilityButton::Cross);
              }

              idAbility = players[i]->GetAbilityByButton(
                  PlayerObject::AbilityButton::Triangle);
              if (idAbility == PlayerObject::Ability::Cleave) {
            ...
            std::vector<ProjectileObject *> owningProjectile =
                players[i + currentPlayer]->GetOwningProjectile();
            for (int j = 0; j < owningProjectile.size(); j++) {
              ProjectileObject *projectile = owningProjectile[j];
              if ((projectile != nullptr) &&
                  (players[i]->GetPlayerNumber() ==
                   projectile->GetOwner()->GetPlayerNumber()) &&
                ...
                float angle = atan2(-player->GetCurrentDirection().y,
                                    player->GetCurrentDirection().x);
                ...
                projectile->SetPosition(
                    players[i]->getPos() +
                    (projectile->GetVelocity() * glm::vec3(15.f, 15.f, 0.f)));
                projectile->SetRotation(angle);
                projectile->SetVelocity(abs(veloX), abs(veloY), PositiveX,
                                        PositiveY);

                // KK_TRACE("players[i]->GetHoldingProjectile() = {0}",
                // players[i]->GetHoldingProjectile());
              }

              // cancel aim
              if ((projectile != nullptr) &&
                  (players[i]->GetIsKnockback() == true ||
                   players[i]->GetIsStun() == true)) {
                players[i]->SetHoldingProjectile(0);
                // players[i + playerNum]->SetIsShooting(false);
                projectile->SetLifeTime(0);
                players[i]->SetIsAiming(false);
                if (Joystick::GetButton(i, Joystick::Button::Circle)) {
                  players[i + currentPlayer]->SetAbilityCooldown(
                      PlayerObject::AbilityButton::Circle, 6);
                }
                if (Joystick::GetButton(i, Joystick::Button::Cross)) {
                  players[i + currentPlayer]->SetAbilityCooldown(
                      PlayerObject::AbilityButton::Cross, 6);
                }
                if (Joystick::GetButton(i, Joystick::Button::Triangle)) {
                  players[i + currentPlayer]->SetAbilityCooldown(
                      PlayerObject::AbilityButton::Triangle, 6);
                }
              }
            }
          }
        ...
        if (Joystick::GetButtonDown(i, Joystick::Button::Triangle)) {
          if (players[i + currentPlayer]->GetCooldown(
                  PlayerObject::AbilityButton::Triangle) <= 0) {
            UsingAbilityKeyDown(i + currentPlayer,
                                PlayerObject::AbilityButton::Triangle);
          }
        }
        ...
        if (Joystick::GetButtonUp(i, Joystick::Button::Triangle)) {
          if (players[i + currentPlayer]->GetCooldown(
                  PlayerObject::AbilityButton::Triangle) <= 0) {
            UsingAbilityKeyUp(i + currentPlayer,
                              PlayerObject::AbilityButton::Triangle);
          }
        }
        ...
        if (Joystick::GetButtonDown(i, Joystick::Button::Circle)) {
          if (players[i + currentPlayer]->GetCooldown(
                  PlayerObject::AbilityButton::Circle) <= 0) {
            UsingAbilityKeyDown(i + currentPlayer,
                                PlayerObject::AbilityButton::Circle);
          }
        }
        ...
        if (Joystick::GetButtonDown(i, Joystick::Button::Cross)) {
          if (players[i + currentPlayer]->GetCooldown(
                  PlayerObject::AbilityButton::Cross) <= 0) {
            UsingAbilityKeyDown(i + currentPlayer,
                                PlayerObject::AbilityButton::Cross);
          }
        }
  ...
  for (int i = 0; i < entityObjects.size(); i++) {
    ...
    for (int j = 0; j < entityObjects.size(); j++) {
      ...
      float previousDeltaX =
          col1->GetPreviousPos().x - col2->GetPreviousPos().x;
      float previousDeltaY =
          col1->GetPreviousPos().y - col2->GetPreviousPos().y;
      ...
      float previousOverlapX = (abs(col1->GetHalfSize().x)) +
                               (abs(col2->GetHalfSize().x)) - previousDelta.x;
      float previousOverlapY = (abs(col1->GetHalfSize().y)) +
                               (abs(col2->GetHalfSize().y)) - previousDelta.y;
      ...
      if (overlapX > 0 && overlapY > 0) {
        ...
        if (col1->GetCollisionType() == Collider::Kinematic &&
          ...
          glm::vec3 newPos(entity1->getPos().x, entity1->getPos().y,
                           entity1->getPos().z);

          if (previousOverlapX > 0) {
            bool isTopSide =
                (col1->GetPreviousPos().y - col2->GetPreviousPos().y) > 0
                    ? true
                    : false;
          ...
          if (previousOverlapY > 0) {
            bool isLeftSide =
                (col1->GetPreviousPos().x - col2->GetPreviousPos().x) < 0
                    ? true
                    : false;
      ...
      entity2->GetCollider()->SetPreviousPos(
          entity2->getPos() + entity2->GetCollider()->GetOffset());
    }
    entity1->GetCollider()->SetPreviousPos(entity1->getPos() +
                                           entity1->GetCollider()->GetOffset());
  }
...
void LevelShowcase::UpdateMovement() {
  for (PlayerObject *player : players) {
    ...
    if (player->GetIsKnockback() == true) {
      ...
      player->SetVelocity(knockbackVeloX / 1.01f, knockbackVeloY / 1.01f,
                          player->GetXIsPositive(), player->GetYIsPositive());

      // KK_CORE_WARN("Set Velocity = {0}, {1}", knockbackVeloX,
      // knockbackVeloY);
    }
...
void LevelShowcase::UpdateUI() {
  ...
  float posX = camera.GetCenterX() -
               (uiWidth * camera.GetCameraWidth() / SCREEN_WIDTH / 2.f) *
                   (playerNumber - 1);
  float posY =
  ...
  for (int i = 0; i < playerNumber; i++) {
    ...
    float posX_current = posX + (ui->getNumOwner() * uiWidth *
                                 camera.GetCameraWidth() / SCREEN_WIDTH);

    ui->SetPosition(glm::vec3(posX_current, posY, 0));
    ui->SetSize(uiWidth * camera.GetCameraWidth() / SCREEN_WIDTH,
                -uiHeight * camera.GetCameraHeight() / SCREEN_HEIGHT);

    for (int j = 0; j < 3; j++) {
      UiObject *uiSkill = playerSkillUIs[i][j];

      float offsetX =
          (57.f * j - 26.f) * camera.GetCameraWidth() / SCREEN_WIDTH;
      ...
      float cooldown =
          players[i]->GetCooldown(static_cast<PlayerObject::AbilityButton>(j));
  ...
  for (UiObject *ui : uiObjects) {
    ...
    case UiObject::Kraken:
      ...
      // krakenSign_t
      float posY_start =
          GameEngine::GetInstance()->GetRenderer()->GetOrthovalue().top -
          (uiHeight / 2.f);
      float posY_end =
          GameEngine::GetInstance()->GetRenderer()->GetOrthovalue().top +
          (uiHeight / 2.f);
    ...
    // ui->SetPosition(glm::vec3(posX + (ui->getNumOwner() * ui->getSize().x *
    // camera.GetCameraWidth() / SCREEN_WIDTH), posY, 0));
  }
  ...
  if (isPause) {
    ...
    AreYouSureBG->SetSize(
        AreYouSureBG->GetSpriteRenderer()->GetSpriteWidth() *
            camera.GetCameraWidth() / SCREEN_WIDTH,
        -AreYouSureBG->GetSpriteRenderer()->GetSpriteHeight() *
            camera.GetCameraHeight() / SCREEN_HEIGHT);
    ...
    YesButton->SetSize(YesButton->GetSpriteRenderer()->GetSpriteWidth() *
                           camera.GetCameraWidth() / SCREEN_WIDTH,
                       -YesButton->GetSpriteRenderer()->GetSpriteHeight() *
                           camera.GetCameraHeight() / SCREEN_HEIGHT);

    posX = centerPosX + (175 * camera.GetCameraWidth() / SCREEN_WIDTH);
    posY = centerPosY - (50 * camera.GetCameraHeight() / SCREEN_HEIGHT);
    NoButton->SetPosition(glm::vec3(posX, posY, 0));
    NoButton->SetSize(NoButton->GetSpriteRenderer()->GetSpriteWidth() *
                          camera.GetCameraWidth() / SCREEN_WIDTH,
                      -NoButton->GetSpriteRenderer()->GetSpriteHeight() *
                          camera.GetCameraHeight() / SCREEN_HEIGHT);

    posX = centerPosX;
    posY = centerPosY;
    OptionBG->SetPosition(glm::vec3(posX, posY, 0));
    OptionBG->SetSize(OptionBG->GetSpriteRenderer()->GetSpriteWidth() *
                          camera.GetCameraWidth() / SCREEN_WIDTH,
                      -OptionBG->GetSpriteRenderer()->GetSpriteHeight() *
                          camera.GetCameraHeight() / SCREEN_HEIGHT);

    for (int i = 0; i < OptionTextList.size(); i++) {
      posX = centerPosX - (165 * camera.GetCameraWidth() / SCREEN_WIDTH);
      posY = centerPosY +
             ((135 + (-i * 100)) * camera.GetCameraHeight() / SCREEN_HEIGHT);
      OptionTextList.at(i)->SetPosition(glm::vec3(posX, posY, 0));
      OptionTextList.at(i)->SetSize(
          OptionTextList.at(i)->GetSpriteRenderer()->GetSpriteWidth() *
              camera.GetCameraWidth() / SCREEN_WIDTH,
          -OptionTextList.at(i)->GetSpriteRenderer()->GetSpriteHeight() *
              camera.GetCameraHeight() / SCREEN_HEIGHT);
    }

    for (int i = 0; i < volumeTrackList.size(); i++) {
      posX = centerPosX - (35 * camera.GetCameraWidth() / SCREEN_WIDTH);
      posY = centerPosY + ((95 + ((-i - 1) * 100)) * camera.GetCameraHeight() /
                           SCREEN_HEIGHT);
      volumeTrackList.at(i)->SetPosition(glm::vec3(posX, posY, 0));
      volumeTrackList.at(i)->SetSize(
          volumeTrackList.at(i)->GetSpriteRenderer()->GetSpriteWidth() *
              camera.GetCameraWidth() / SCREEN_WIDTH,
          -volumeTrackList.at(i)->GetSpriteRenderer()->GetSpriteHeight() *
              camera.GetCameraHeight() / SCREEN_HEIGHT);
    }
    ...
    for (int i = 0; i < volumeBoxList.size(); i++) {
      ...
      volumeBoxList.at(i)->SetSize(
          volumeBoxList.at(i)->GetSpriteRenderer()->GetSpriteWidth() *
              camera.GetCameraWidth() / SCREEN_WIDTH,
          -volumeBoxList.at(i)->GetSpriteRenderer()->GetSpriteHeight() *
              camera.GetCameraHeight() / SCREEN_HEIGHT);
    }
    ...
    DisplayBox->SetSize(DisplayBox->GetSpriteRenderer()->GetSpriteWidth() *
                            camera.GetCameraWidth() / SCREEN_WIDTH,
                        -DisplayBox->GetSpriteRenderer()->GetSpriteHeight() *
                            camera.GetCameraHeight() / SCREEN_HEIGHT);

    posX = centerPosX + (90 * camera.GetCameraWidth() / SCREEN_WIDTH);
    posY = centerPosY + (65 * camera.GetCameraHeight() / SCREEN_HEIGHT);
    DisplayDropDown->SetPosition(glm::vec3(posX, posY, 0));
    DisplayDropDown->SetSize(
        DisplayDropDown->GetSpriteRenderer()->GetSpriteWidth() *
            camera.GetCameraWidth() / SCREEN_WIDTH,
        -DisplayDropDown->GetSpriteRenderer()->GetSpriteHeight() *
            camera.GetCameraHeight() / SCREEN_HEIGHT);
  ...
  if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags)) {
    for (int i = 0; i < playerSize; i++) {
      ...
      if (ImGui::BeginTabItem(tabname.c_str())) {
        ...
        ImGui::SameLine();
        ImGui::SeparatorText("");
        ImGui::Text("Position: %f, %f, %f", players[i]->getPos().x,
                    players[i]->getPos().y, players[i]->getPos().z);

        ImGui::Text("isShooting: %s",
                    players[i]->GetIsShooting() ? "true" : "false");
        ImGui::Text("isAiming: %s",
                    players[i]->GetIsAiming() ? "true" : "false");
        ImGui::Text("isSlow: %s", players[i]->GetIsSlow() ? "true" : "false");
        ImGui::Text("isDashing: %s",
                    players[i]->GetIsDashing() ? "true" : "false");
        ImGui::Text("isKnockback: %s",
                    players[i]->GetIsKnockback() ? "true" : "false");
        ImGui::Text("isStun: %s", players[i]->GetIsStun() ? "true" : "false");
        ImGui::Text("isOnGround: %s",
                    players[i]->GetIsOnGround() ? "true" : "false");
        ImGui::Text("Current Velocity: %f, %f", players[i]->GetVelocity().x,
                    players[i]->GetVelocity().y);

        /*ImGui::DragFloat("ColX Button", &groundColX[i], 2.0f, 0.0f, 1024.f,
        "%.3f"); ImGui::DragFloat("ColY Button", &groundColY[i], 2.0f, 0.0f,
        1024.f, "%.3f");*/
        ImGui::DragFloat("Col offset X", &groundColOffsetX[i], 2.0f, -1024.f,
                         1024.f, "%.3f");
        ImGui::DragFloat("Col offset Y", &groundColOffsetY[i], 2.0f, -1024.f,
                         1024.f, "%.3f");

        players[i]->GetGroundColliderObject()->SetCollisionOffset(
            glm::vec2(groundColOffsetX[i], groundColOffsetY[i]));
        /*Fireball = 0,
                Trap = 1,
                Dash = 2,
                TNT = 3,
        ...
        for (int j = 0; j < 3; j++) {
          ...
          ImGui::Text("ability %d cooldown: %.2f", i,
                      players[i]->GetCooldown(
                          static_cast<PlayerObject::AbilityButton>(j)));
          ImGui::RadioButton("Fireball", &playersSkill[i][j],
                             static_cast<int>(PlayerObject::Ability::Fireball));
          ImGui::SameLine();
          ImGui::RadioButton("Trap", &playersSkill[i][j],
                             static_cast<int>(PlayerObject::Ability::Trap));
          ImGui::SameLine();
          ImGui::RadioButton("Dash", &playersSkill[i][j],
                             static_cast<int>(PlayerObject::Ability::Dash));
          // ImGui::SameLine();
          ImGui::RadioButton("TNT", &playersSkill[i][j],
                             static_cast<int>(PlayerObject::Ability::TNT));
          ImGui::SameLine();
          ImGui::RadioButton("Teleport", &playersSkill[i][j],
                             static_cast<int>(PlayerObject::Ability::Teleport));
          ImGui::SameLine();
          ImGui::RadioButton("Bola", &playersSkill[i][j],
                             static_cast<int>(PlayerObject::Ability::Bola));
          ImGui::SameLine();
          ImGui::RadioButton("Cleave", &playersSkill[i][j],
                             static_cast<int>(PlayerObject::Ability::Cleave));
          ImGui::SeparatorText("");
...
void LevelShowcase::Movement(float axisX, float axisY, bool isPositiveX,
                             bool isPositiveY) {}
...
void LevelShowcase::GroundTileRefactor() {
  for (int i = 0; i < MAP_HEIGHT; i++) {
    for (int j = 0; j < MAP_WIDTH; j++) {
      ...
      if (i == 0 || i == MAP_HEIGHT - 1 || j == 0 || j == MAP_WIDTH - 1) {
        continue;
      } else if (tilesList[i][j]->currAnimState ==
                 TileObject::AnimationState::FinishBreaking) {
        ...
        // "../Resource/Texture/Props/prop_spr_vfx_smoke.png", 200, 200, 800,
        // 200);
        ...
        collapseTile->SetTextureWithID(
            spriteList.find("CollapseTile")->second,
            spriteList.find("CollapseTile")->second.textureid);
        collapseTile->GetSpriteRenderer()->ShiftTo(
            tilesList[i][j]->GetSpriteRenderer()->GetRow(),
            tilesList[i][j]->GetSpriteRenderer()->GetColumn());

        AddEntityToScene(collapseTile);
        tilesList[i][j]->currAnimState =
            TileObject::AnimationState::FinishBreaking;
      ...
      if (pos.first != 99) {
        tilesList[i][j]->GetSpriteRenderer()->ShiftTo(pos.first - 1,
                                                      pos.second - 1);
      } else {
        tilesList[i][j]->SetIsActive(false);
      }

      // std::cout << "posX = " << obj->getPos().x << " posY = " <<
      // obj->getPos().y << std::endl;
    }
    // std::cout << std::endl;
  }
}

void LevelShowcase::TileImport(
    std::array<std::array<int, MAP_WIDTH>, MAP_HEIGHT> &TileBuffer,
    std::string fileName) {
...
void LevelShowcase::UsingAbilityKeyDown(int numPlayer,
                                        PlayerObject::AbilityButton button) {

  PlayerObject::Ability idAbility =
      players[numPlayer]->GetAbilityByButton(button);
    ...
    case PlayerObject::Ability::Teleport:
      ...
      if (!players[numPlayer]->GetIsAiming()) {
        if (players[numPlayer]->GetIsShooting()) {
          for (ProjectileObject *projectile :
               players[numPlayer]->GetOwningProjectile()) {
            if (projectile->GetType() ==
                ProjectileObject::TypeProjectile::Teleport) {
...
void LevelShowcase::UsingAbilityKeyUp(int numPlayer,
                                      PlayerObject::AbilityButton button) {
  PlayerObject::Ability idAbility =
      players[numPlayer]->GetAbilityByButton(button);
  // std::cout << "idAbility " << idAbility << std::endl;
  if (players[numPlayer]->GetCooldown(button) <= 0) {
    ...
    case PlayerObject::Ability::Fireball:
      if (players[numPlayer]->GetIsAiming()) {
        if (players[numPlayer]->GetHoldingProjectile() ==
            ProjectileObject::TypeProjectile::Fireball) {
    ...
    case PlayerObject::Ability::Bola:
      if (players[numPlayer]->GetIsAiming()) {
        if (players[numPlayer]->GetHoldingProjectile() ==
            ProjectileObject::TypeProjectile::Bola) {
...
void LevelShowcase::AimFireball(int numPlayer,
                                PlayerObject::AbilityButton button) {
  players[numPlayer]->SetVelocity(0, 0, false, false);
  players[numPlayer]->SetIsAiming(true);
  players[numPlayer]->SetHoldingProjectile(
      ProjectileObject::TypeProjectile::Fireball);
  ProjectileObject *projectile = new ProjectileObject();
  projectile->SetAnimationSprite(ProjectileObject::Collide,
                                 spriteList.find("Bomb_Explode")->second);
  ...
  // projectile->SetIsActive(false);
  std::cout << "Owner " << projectile->GetOwner()->GetPlayerNumber()
            << std::endl;
...
void LevelShowcase::ShootFireball(int numPlayer,
                                  PlayerObject::AbilityButton button) {
...
void LevelShowcase::Trap(int numPlayer, PlayerObject::AbilityButton button) {
  players[numPlayer]->ChangeAnimationState(
      PlayerObject::AnimationState::PlaceItem);
  ...
  Trap->SetAnimationSprite(TrapObject::AnimationState::Idle,
                           spriteList.find("Trap")->second);
  Trap->SetAnimationSprite(TrapObject::AnimationState::Collide,
                           spriteList.find("Trap_Explode")->second);
...
void LevelShowcase::TNT(int numPlayer, PlayerObject::AbilityButton button) {
  ...
  TNT->SetAnimationSprite(TrapObject::AnimationState::Idle,
                          spriteList.find("TNT")->second);
  TNT->SetAnimationSprite(TrapObject::AnimationState::Collide,
                          spriteList.find("Landmine_Explode")->second);
...
void LevelShowcase::AimTeleport(int numPlayer,
                                PlayerObject::AbilityButton button) {
  players[numPlayer]->SetVelocity(0, 0, false, false);
  players[numPlayer]->SetIsAiming(true);
  players[numPlayer]->SetHoldingProjectile(
  ...
  ProjectileObject *projectile = new ProjectileObject();
  projectile->SetAnimationSprite(ProjectileObject::Collide,
                                 spriteList.find("Teleport_Explode")->second);
...
void LevelShowcase::ShootTeleport(int numPlayer,
                                  PlayerObject::AbilityButton button) {
...
void LevelShowcase::AimBola(int numPlayer, PlayerObject::AbilityButton button) {
  ...
  ProjectileObject *projectile = new ProjectileObject();
  projectile->SetAnimationSprite(ProjectileObject::Collide,
                                 spriteList.find("Stun_Explode")->second);
...
void LevelShowcase::ShootBola(int numPlayer,
                              PlayerObject::AbilityButton button) {
  players[numPlayer]->SetIsAiming(false);
  for (ProjectileObject *projectile :
       players[numPlayer]->GetOwningProjectile()) {
...
void LevelShowcase::AimCleave(int numPlayer,
                              PlayerObject::AbilityButton button) {
  players[numPlayer]->SetVelocity(0, 0, false, false);
  players[numPlayer]->SetIsAiming(true);
  players[numPlayer]->SetHoldingProjectile(
      ProjectileObject::TypeProjectile::Cleave);
  // ProjectileObject* projectile = new ProjectileObject();
  //
  ...
  ////projectile->SetIsActive(false);
  // std::cout << "Owner " << projectile->GetOwner()->GetPlayerNumber() <<
  // std::endl; objectsList.push_back(projectile);
  // entityObjects.push_back(projectile);
  ////players[numPlayer]->SetAbilityCooldown(button, CleaveCooldown);
  // players[numPlayer]->AddOwningProjectile(projectile);
}

void LevelShowcase::ShootCleave(int numPlayer,
                                PlayerObject::AbilityButton button) {
  players[numPlayer]->SetIsAiming(false);
  ...
  float veloY = player->GetCurrentDirection().y;
  float angle =
      atan2(-player->GetCurrentDirection().y, player->GetCurrentDirection().x);
  ...
  projectile->SetPosition(player->getPos() + (projectile->GetVelocity() *
...
void LevelShowcase::SaveConfigInfo(const std::string &fileName) {
  ...
  data["groundColOffsetY"] = {{"0", groundColOffsetY[0]},
  ...
  for (int i = 0; i < 4; i++) {
    ...
    data[playerName] = {playersSkill[i][0], playersSkill[i][1],
                        playersSkill[i][2]};
  }
