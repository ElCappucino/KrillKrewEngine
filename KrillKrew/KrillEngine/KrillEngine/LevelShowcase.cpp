...
void LevelShowcase::LevelLoad()
{
    ...
    // Cleave
    spriteList["P1_Cleave_Down"] =
        SpritesheetInfo("P1_Cleave_Down", "../Resource/Texture/Ham/P1_CleaveDown.png", 402, 402, 1608, 402, false);
    spriteList["P1_Cleave_Side"] =
        SpritesheetInfo("P1_Cleave_Side", "../Resource/Texture/Ham/P1_CleaveSide.png", 402, 402, 1608, 402, false);
    ...
    // Smash
    spriteList["P1_Smash_DiagDown"] =
        SpritesheetInfo("P1_Smash_DiagDown", "../Resource/Texture/Ham/P1_SmashDiagDown.png", 302, 302, 1208, 302, false);
    spriteList["P1_Smash_DiagUp"] =
        SpritesheetInfo("P1_Smash_DiagUp", "../Resource/Texture/Ham/P1_SmashDiagUp.png", 302, 302, 1208, 302, false);
    ...
    // Cleave
    spriteList["P2_Cleave_Down"] =
        SpritesheetInfo("P2_Cleave_Down", "../Resource/Texture/Byssa/P2_CleaveDown.png", 402, 402, 1608, 402, false);
    spriteList["P2_Cleave_Side"] =
        SpritesheetInfo("P2_Cleave_Side", "../Resource/Texture/Byssa/P2_CleaveSide.png", 402, 402, 1608, 402, false);
    ...
    // Smash
    spriteList["P2_Smash_DiagDown"] =
        SpritesheetInfo("P2_Smash_DiagDown", "../Resource/Texture/Byssa/P2_SmashDiagDown.png", 302, 302, 1208, 302, false);
    spriteList["P2_Smash_DiagUp"] =
        SpritesheetInfo("P2_Smash_DiagUp", "../Resource/Texture/Byssa/P2_SmashDiagUp.png", 302, 302, 1208, 302, false);
    spriteList["P2_Smash_Down"] = SpritesheetInfo("P2_SmashDown", "../Resource/Texture/Byssa/P2_SmashDown.png", 302, 302, 1208, 302, false);
    spriteList["P2_Smash_Side"] =
        SpritesheetInfo("P2_Smash_Side", "../Resource/Texture/Byssa/P2_SmashSide.png", 302, 302, 1208, 302, false);
    ...
    spriteList["P2_Smash_DiagUp"] =
        SpritesheetInfo("P2_Smash_DiagUp", "../Resource/Texture/Byssa/P2_SmashDiagUp.png", 302, 302, 1208, 302, false);
    spriteList["P2_Smash_Down"] =
        SpritesheetInfo("P2_Smash_Down", "../Resource/Texture/Byssa/P2_SmashDown.png", 302, 302, 1208, 302, false);
    spriteList["P2_Smash_Side"] =
        SpritesheetInfo("P2_Smash_Side", "../Resource/Texture/Byssa/P2_SmashSide.png", 302, 302, 1208, 302, false);
    spriteList["P2_Smash_Up"] = SpritesheetInfo("P2_Smash_Up", "../Resource/Texture/Byssa/P2_SmashUp.png", 302, 302, 1208, 302, false);
    // Stun
    ...
    // Cleave
    spriteList["P3_Cleave_Down"] =
        SpritesheetInfo("P3_Cleave_Down", "../Resource/Texture/Xoey/P3_CleaveDown.png", 402, 402, 1608, 402, false);
    spriteList["P3_Cleave_Side"] =
        SpritesheetInfo("P3_Cleave_Side", "../Resource/Texture/Xoey/P3_CleaveSide.png", 402, 402, 1608, 402, false);
    ...
    // Smash
    spriteList["P3_Smash_DiagDown"] =
        SpritesheetInfo("P3_Smash_DiagDown", "../Resource/Texture/Xoey/P3_SmashDiagDown.png", 302, 302, 1208, 302, false);
    spriteList["P3_Smash_DiagUp"] =
        SpritesheetInfo("P3_Smash_DiagUp", "../Resource/Texture/Xoey/P3_SmashDiagUp.png", 302, 302, 1208, 302, false);
    ...
    // Cleave
    spriteList["P4_Cleave_Down"] =
        SpritesheetInfo("P4_Cleave_Down", "../Resource/Texture/Crunk/P4_CleaveDown.png", 402, 402, 1608, 402, false);
    spriteList["P4_Cleave_Side"] =
        SpritesheetInfo("P4_Cleave_Side", "../Resource/Texture/Crunk/P4_CleaveSide.png", 402, 402, 1608, 402, false);
    ...
    // Smash
    spriteList["P4_Smash_DiagDown"] =
        SpritesheetInfo("P4_Smash_DiagDown", "../Resource/Texture/Crunk/P4_SmashDiagDown.png", 302, 302, 1208, 302, false);
    spriteList["P4_Smash_DiagUp"] =
        SpritesheetInfo("P4_Smash_DiagUp", "../Resource/Texture/Crunk/P4_SmashDiagUp.png", 302, 302, 1208, 302, false);
    spriteList["P4_Smash_Down"] =
        SpritesheetInfo("P4_Smash_Down", "../Resource/Texture/Crunk/P4_SmashDown.png", 302, 302, 1208, 302, false);
    spriteList["P4_Smash_Side"] =
        SpritesheetInfo("P4_Smash_Side", "../Resource/Texture/Crunk/P4_SmashSide.png", 302, 302, 1208, 302, false);
    ...
    spriteList["Teleport"] =
        SpritesheetInfo("Teleport", "../Resource/Texture/Ability/abi_spr_teleport_projectile.png", 211, 97, 422, 97, true);
    ...
    spriteList["Bomb_Explode"] =
        SpritesheetInfo("Bomb_Explode", "../Resource/Texture/Ability/abi_spr_bomb_explosion.png", 498, 498, 2490, 498, false);
    spriteList["Landmine_Explode"] =
        SpritesheetInfo("Landmine_Explode", "../Resource/Texture/Ability/abi_spr_landmine_explosion.png", 370, 370, 2590, 370, false);
    spriteList["Teleport_Explode"] =
        SpritesheetInfo("Teleport_Explode", "../Resource/Texture/Ability/abi_spr_teleport_explosion.png", 250, 250, 1000, 250, false);
    spriteList["Stun_Explode"] =
        SpritesheetInfo("Stun_Explode", "../Resource/Texture/Ability/abi_spr_stun_explosion.png", 400, 400, 1600, 400, false);
    spriteList["Trap_Explode"] =
        SpritesheetInfo("Trap_Explode", "../Resource/Texture/Ability/abi_spr_jellyfish_explosion.png", 332, 332, 4316, 332, false);
    ...
    spriteList["AbilityGameplay_UI"] =
        SpritesheetInfo("AbilityGameplay_UI", "../Resource/Texture/Gameplay/UI_GP_Abilityicon.png", 69, 69, 552, 69);
    spriteList["AbilityCover_UI"] =
        SpritesheetInfo("AbilityCover_UI", "../Resource/Texture/Gameplay/UI_GP_Abilityicon_black.png", 69, 69, 69, 69);

    spriteList["AbilityIcon_Circle_UI"] =
        SpritesheetInfo("AbilityCover_UI", "../Resource/Texture/Gameplay/UI_GP_Abilityicon_circle.png", 69, 69, 69, 69);
    spriteList["AbilityIcon_Cross_UI"] =
        SpritesheetInfo("AbilityCover_UI", "../Resource/Texture/Gameplay/UI_GP_Abilityicon_cross.png", 69, 69, 69, 69);
    spriteList["AbilityIcon_Triangle_UI"] =
        SpritesheetInfo("AbilityCover_UI", "../Resource/Texture/Gameplay/UI_GP_Abilityicon_triangle.png", 69, 69, 69, 69);
    ...
    spriteList["OptionsDisplay"] =
        SpritesheetInfo("OptionsDisplay", "../Resource/Texture/Pause and Options/UI_Options_Display_tab.png", 309, 50, 1236, 50);
    spriteList["OptionsDisplayDropdown"] = SpritesheetInfo(
        "OptionsDisplayDropdown", "../Resource/Texture/Pause and Options/UI_Options_Display_tabdropdown.png", 300, 94, 600, 94);
    spriteList["OptionsText"] =
        SpritesheetInfo("OptionsText", "../Resource/Texture/Pause and Options/UI_Options_text.png", 183, 25, 1464, 25);
    spriteList["OptionsVolumeBox"] =
        SpritesheetInfo("OptionsVolumeBox", "../Resource/Texture/Pause and Options/UI_Options_Volume_box.png", 32, 32, 128, 32);
    spriteList["OptionsVolumeKnob"] =
        SpritesheetInfo("OptionsVolumeKnob", "../Resource/Texture/Pause and Options/UI_Options_Volume_knob.png", 21, 41, 42, 41);
    spriteList["OptionsVolumeTrack"] =
        SpritesheetInfo("OptionsVolumeTrack", "../Resource/Texture/Pause and Options/UI_Options_Volume_track.png", 406, 12, 812, 12);

    spriteList["Tentacle_Up"] =
        SpritesheetInfo("Tentacle_Up", "../Resource/Texture/Props/UI_GP_Event_VFX_Tentecle_Up.png", 319, 334, 1914, 334);
    spriteList["Tentacle_Idle"] =
        SpritesheetInfo("Tentacle_Idle", "../Resource/Texture/Props/UI_GP_Event_VFX_Tentecle_Idle.png", 319, 334, 4147, 334);
...
void LevelShowcase::UpdateKrakenEvent()
{
    ...
    {
        if (KrakenEventOffset_bottom >= (MAP_HEIGHT / 2) + 1 || KrakenEventOffset_top >= (MAP_HEIGHT / 2) + 1 ||
            KrakenEventOffset_left >= (MAP_WIDTH / 2) + 1 || KrakenEventOffset_right >= (MAP_WIDTH / 2) + 1)
        {
            return;
        }
...
void LevelShowcase::UpdateInput()
{
    if (SDL_NumJoysticks() > 0)
    {
        ...
        if (isPause)
        {
            ...
            {
                if (abs(norAxisY) < 0.3f && norAxisX < 0.3f && ! Joystick::GetButton(0, Joystick::Button::DPAD_Up) &&
            ...
            for (int i = 0; i < playerSize; i++)
            {
                ...
                if (players[i + currentPlayer]->GetIsFell() == false)
                {
                    ...
                    if (players[i + currentPlayer]->GetIsKnockback() == false)
                    {
                        if (players[i + currentPlayer]->GetIsStun() == true)
                        {
                            ...
                            players[i + currentPlayer]->SetVelocity(
                                0, 0, isPositiveXOld[i + currentPlayer], isPositiveYOld[i + currentPlayer]);
                        }
                        else if (players[i + currentPlayer]->GetIsDashing() == true)
                        {
                            // use old velo during dash to disable control
                            players[i + currentPlayer]->SetVelocity(abs(norAxisXOld[i + currentPlayer]),
                        ...
                        else if (players[i + currentPlayer]->GetIsAiming() == false)
                        {
                            ...
                            players[i + currentPlayer]->SetVelocity(abs(norAxisX), abs(norAxisY), isPositiveX, isPositiveY);
                        }
                    }
                    ...
                    if (players[i + currentPlayer]->GetIsAiming())
                    {
                        ...
                        if (players[i]->GetHoldingProjectile() == static_cast<int>(ProjectileObject::Cleave) &&
                        ...
                        for (int j = 0; j < owningProjectile.size(); j++)
                        {
                            ...
                            if ((projectile != nullptr) && (players[i]->GetPlayerNumber() == projectile->GetOwner()->GetPlayerNumber()) &&
...
void LevelShowcase::UpdateCollision()
{
    ...
    for (int i = 0; i < entityObjects.size(); i++)
    {
        ...
        if (entity1->GetCollider()->GetCollisionType() == Collider::Static || tile != nullptr)
        {
            continue;
        }
        ...
        for (int j = 0; j < entityObjects.size(); j++)
        {
            ...
            if (overlapX > 0 && overlapY > 0)
            {
                ...
                if (col1->GetCollisionType() == Collider::Kinematic && col2->GetCollisionType() == Collider::Static)
                {
