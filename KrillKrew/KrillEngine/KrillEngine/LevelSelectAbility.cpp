...
void LevelSelectAbility::LevelLoad() {
  ...
  spriteList["BG"] = SpritesheetInfo(
      "BG", "../Resource/Texture/CharacterSelection/UI_CS_Background.png", 1920,
      1080, 1920, 1080);

  spriteList["Player_Window1"] = SpritesheetInfo(
      "Player_Window1",
      "../Resource/Texture/CharacterSelection/UI_CS_PlayerWindow_1.png", 284,
      373, 1988, 373);
  spriteList["Player_Window2"] = SpritesheetInfo(
      "Player_Window2",
      "../Resource/Texture/CharacterSelection/UI_CS_PlayerWindow_2.png", 284,
      373, 1988, 373);
  spriteList["Player_Window3"] = SpritesheetInfo(
      "Player_Window3",
      "../Resource/Texture/CharacterSelection/UI_CS_PlayerWindow_3.png", 284,
      373, 1988, 373);
  spriteList["Player_Window4"] = SpritesheetInfo(
      "Player_Window4",
      "../Resource/Texture/CharacterSelection/UI_CS_PlayerWindow_4.png", 284,
      373, 1988, 373);

  spriteList["Player_Icon"] = SpritesheetInfo(
      "Player_Icon",
      "../Resource/Texture/CharacterSelection/UI_CS_PlayerProfile.png", 175,
      152, 700, 152);
  spriteList["Player_Icon_Small"] = SpritesheetInfo(
      "Player_Icon_Small",
      "../Resource/Texture/CharacterSelection/UI_CS_PlayerProfile_Small.png",
      127, 120, 508, 120);

  spriteList["Ability_Icon"] = SpritesheetInfo(
      "Ability_Icon",
      "../Resource/Texture/CharacterSelection/UI_CS_Abilityicon_Big.png", 160,
      160, 1280, 160);
  spriteList["Ability_Icon_Small"] = SpritesheetInfo(
      "Ability_Icon_Small",
      "../Resource/Texture/CharacterSelection/UI_CS_Abilityicon_Small.png", 72,
      72, 648, 72);

  spriteList["Player_Remain"] = SpritesheetInfo(
      "Player_Remain",
      "../Resource/Texture/CharacterSelection/UI_CS_PlayerRemain.png", 292, 133,
      2044, 133);
  spriteList["Player_Hover"] = SpritesheetInfo(
      "Player_Hover",
      "../Resource/Texture/CharacterSelection/PlayerAbilityHover.png", 450, 283,
      1800, 283);
}
...
void LevelSelectAbility::LevelInit() {
  ...
  for (int i = 0; i < 4; i++) {
    ...
    PlayerWindow->GetSpriteRenderer()->ShiftTo(
        PlayerWindow->GetSpriteRenderer()->GetRow(), 0);
    PlayerWindow->SetSize(configs.at(0)->width, -configs.at(0)->height);
    if (i == 2) {
      axisX = 1;
      axisY = 1;
    }
    PlayerWindow->SetPosition(
        glm::vec3(configs.at(0)->posX + (configs.at(0)->offSetX * axisX),
                  configs.at(0)->posY + (configs.at(0)->offSetY * axisY), 0));
    axisX++;
  ...
  PlayerRemain->GetSpriteRenderer()->ShiftTo(
      PlayerRemain->GetSpriteRenderer()->GetRow(), 3);
  PlayerRemain->SetSize(configs.at(1)->width, -configs.at(1)->height);
  PlayerRemain->SetPosition(
      glm::vec3(configs.at(1)->posX, configs.at(1)->posY, 0));
  ...
  for (int i = 0; i < 7; i++) {
    if (i < 3) {
      ...
      AbilityIconTop->SetPosition(
          glm::vec3(configs.at(2)->posX + (configs.at(2)->offSetX * axisX),
                    configs.at(2)->posY, 0));
      AbilityIconTop->GetSpriteRenderer()->ShiftTo(
          AbilityIconTop->GetSpriteRenderer()->GetRow(), i);
      ...
      AbilityIconDown->SetPosition(
          glm::vec3(configs.at(3)->posX + (configs.at(0)->offSetX * axisX),
                    configs.at(3)->posY, 0));
      AbilityIconDown->GetSpriteRenderer()->ShiftTo(
          AbilityIconDown->GetSpriteRenderer()->GetRow(), i);
  ...
  /*for (int i = 0; i < 4; i++) {
          ...
          playerHover->SetPosition(glm::vec3(configs.at(4)->posX,
  configs.at(4)->posY, 0));
          playerHover->GetSpriteRenderer()->ShiftTo(playerHover->GetSpriteRenderer()->GetRow(),
  i); playerHover->setNumOwner(i); objectsList.push_back(playerHover);
  ...
  for (int i = 0; i < 4; i++) {
          ...
          PlayerIcon->SetPosition(glm::vec3(configs.at(5)->posX +
  (configs.at(5)->offSetX * axisX), configs.at(5)->posY +
  (configs.at(5)->offSetY * axisY), 0)); axisX++; PlayerIcon->setNumOwner(i);
  ...
  for (int i = 0; i < 4; i++) {
          ...
          PlayerIconSmall->SetSize(configs.at(6)->width,
  -configs.at(6)->height); if (i == 2) { axisX = 0; axisY = -1;
          }
          PlayerIconSmall->SetPosition(glm::vec3(configs.at(6)->posX +
  (configs.at(6)->offSetX * axisX), configs.at(6)->posY +
  (configs.at(6)->offSetY * axisY), 0)); axisX++;
  ...
  axisY = 0;
  for (int i = 0; i < 4; i++) {
          std::vector<UiObject*>* abilityIconSmallList = new
  std::vector<UiObject*>; for (int j = 0; j < 3; j++) { UiObject*
  abilityIconSmall = new UiObject();
                  abilityIconSmall->SetSpriteInfo(spriteList.find("Ability_Icon_Small")->second);
                  abilityIconSmall->GetSpriteRenderer()->ShiftTo(abilityIconSmall->GetSpriteRenderer()->GetRow(),
  8); if (axisX < 3) { abilityIconSmall->SetSize(configs.at(7)->width,
  -configs.at(7)->height);
                          abilityIconSmall->SetPosition(glm::vec3(configs.at(7)->posX
  + (configs.at(7)->offSetX * axisX), configs.at(7)->posY +
  (configs.at(7)->offSetY * axisY), 0));
                  }
                  else {
                          abilityIconSmall->SetSize(configs.at(7)->width,
  -configs.at(7)->height);
                          abilityIconSmall->SetPosition(glm::vec3(configs.at(7)->posX
  + (configs.at(7)->offSetX * (axisX - 3)) + configs.at(0)->offSetX,
  ...
  if (SDL_NumJoysticks() > 0) {
    ...
    for (int i = 0; i < SDL_NumJoysticks(); i++) {
      ...
      if (Joystick::GetButtonDown(i, Joystick::Button::Triangle) &&
          playerWindowList[i]->GetSpriteRenderer()->GetColumn() == 0) {
        ready[i] = 0;
        ...
        playerHover->SetSpriteInfo(spriteList.find("Player_Hover")->second);
        playerHover->SetSize(configs.at(4)->width, -configs.at(4)->height);
        playerHover->SetPosition(
            glm::vec3(configs.at(4)->posX, configs.at(4)->posY, 0));
        playerHover->GetSpriteRenderer()->ShiftTo(
            playerHover->GetSpriteRenderer()->GetRow(), i);
        ...
        // Player icon(small)
        UiObject *PlayerIconSmall = new UiObject();
        PlayerIconSmall->SetSpriteInfo(
            spriteList.find("Player_Icon_Small")->second);
        ...
        PlayerIconSmall->SetPosition(
            glm::vec3(configs.at(6)->posX +
                          (configs.at(6)->offSetX * axisXplayerIconSmall),
                      configs.at(6)->posY +
                          (configs.at(6)->offSetY * axisYplayerIconSmall),
                      0));
        PlayerIconSmall->setNumOwner(i);
        objectsList.push_back(PlayerIconSmall);
        playerIconSmallList.push_back(PlayerIconSmall);
        ...
        // player ability
        std::vector<UiObject *> *abilityIconSmallList =
            new std::vector<UiObject *>;
        for (int j = 0; j < 3; j++) {
          UiObject *abilityIconSmall = new UiObject();
          abilityIconSmall->SetSpriteInfo(
              spriteList.find("Ability_Icon_Small")->second);
          abilityIconSmall->GetSpriteRenderer()->ShiftTo(
              abilityIconSmall->GetSpriteRenderer()->GetRow(), 8);
          ...
          if (axisXAbilityIconSmall < 3) {
            abilityIconSmall->SetSize(configs.at(7)->width,
                                      -configs.at(7)->height);
            abilityIconSmall->SetPosition(
                glm::vec3(configs.at(7)->posX +
                              (configs.at(7)->offSetX * axisXAbilityIconSmall),
                          configs.at(7)->posY +
                              (configs.at(7)->offSetY * axisYAbilityIconSmall),
                          0));
          } else {
            abilityIconSmall->SetSize(configs.at(7)->width,
                                      -configs.at(7)->height);
            abilityIconSmall->SetPosition(glm::vec3(
                configs.at(7)->posX +
                    (configs.at(7)->offSetX * (axisXAbilityIconSmall - 3)) +
                    configs.at(0)->offSetX,
                configs.at(7)->posY +
                    (configs.at(7)->offSetY * axisYAbilityIconSmall),
                0));
          }
      ...
      float axisX =
          Joystick::GetAxis(i, Joystick::Axis::LeftStickHorizontal) / 32768.0f;
      float axisY =
      ...
      if (playerWindowList.at(i)->GetSpriteRenderer()->GetColumn() != 0 &&
          ready[i] == false) {
        // move hover
        if (playerMove[i] == false) {
          if (Joystick::GetButtonDown(i, Joystick::Button::DPAD_Right) ||
              Joystick::GetButtonDown(i, Joystick::Button::DPAD_Up) || right ||
              up) {
            playerHoverWhere[i]++;
            helpHover++;
          ...
          if (Joystick::GetButtonDown(i, Joystick::Button::DPAD_Left) ||
              Joystick::GetButtonDown(i, Joystick::Button::DPAD_Down) || left ||
              down) {
            playerHoverWhere[i]--;
            helpHover--;
          ...
          if (playerHoverWhere[i] > 2) {
            playerHoverList.at(i)->SetPosition(glm::vec3(
                configs.at(4)->posX + (configs.at(4)->offSetX *
                                       (playerHoverWhere[i] - 4 + helpHover)),
                configs.at(4)->posY + AbilityIconListDown.at(0)->getPos().y +
                    configs.at(4)->offSetY,
                0));
          } else {
            playerHoverList.at(i)->SetPosition(glm::vec3(
                configs.at(4)->posX + (configs.at(4)->offSetX *
                                       (playerHoverWhere[i] + helpHover)),
                configs.at(4)->posY, 0));
          }
        }
        ...
        if (Joystick::GetButtonDown(i, Joystick::Button::L1)) {
          playerIconSmallList.at(i)->GetSpriteRenderer()->ShiftTo(
              playerIconSmallList.at(i)->GetSpriteRenderer()->GetRow(),
              playerIconSmallList.at(i)->GetSpriteRenderer()->GetColumn() - 1);
        }
        ...
        if (Joystick::GetButtonDown(i, Joystick::Button::Square)) {
          ...
          for (int j = 0; j < playerIconSmallList.size(); j++) {
            for (int k = 0; k < SDL_NumJoysticks(); k++) {
              if (playerIconSmallList.at(j)->getNumOwner() == i &&
                  playerIconSmallList.at(j)->GetSpriteRenderer()->GetColumn() ==
                      character[k]) {
                canReady = false;
              }
            }
          ...
          if (canReady == true) {
            playerWindowList.at(i)->GetSpriteRenderer()->ShiftTo(
                playerWindowList.at(i)->GetSpriteRenderer()->GetRow(),
                playerIconSmallList.at(i)->GetSpriteRenderer()->GetColumn() +
                    2);
            playerRemainList.at(0)->GetSpriteRenderer()->ShiftTo(
                playerRemainList.at(0)->GetSpriteRenderer()->GetRow(),
                playerRemainList.at(0)->GetSpriteRenderer()->GetColumn() + 1);
            ...
            PlayerIcon->SetSpriteInfo(spriteList.find("Player_Icon")->second);
            PlayerIcon->SetSize(configs.at(5)->width, -configs.at(5)->height);
            PlayerIcon->GetSpriteRenderer()->ShiftTo(
                PlayerIcon->GetSpriteRenderer()->GetRow(),
                playerIconSmallList.at(i)->GetSpriteRenderer()->GetColumn());
            if (i == 0) {
              axisXplayerIcon = 0;
              axisYplayerIcon = 0;
            ...
            PlayerIcon->SetPosition(
                glm::vec3(configs.at(5)->posX +
                              (configs.at(5)->offSetX * axisXplayerIcon),
                          configs.at(5)->posY +
                              (configs.at(5)->offSetY * axisYplayerIcon),
                          0));
            ...
            playerWindowList.at(i)->GetSpriteRenderer()->ShiftTo(
                playerWindowList.at(i)->GetSpriteRenderer()->GetRow(), 6);
          }
        }
      }

      else if (Joystick::GetButtonDown(i, Joystick::Button::Square) &&
               ready[i] == true) {
        playerWindowList.at(i)->GetSpriteRenderer()->ShiftTo(
            playerWindowList.at(i)->GetSpriteRenderer()->GetRow(), 1);
        playerRemainList.at(0)->GetSpriteRenderer()->ShiftTo(
            playerRemainList.at(0)->GetSpriteRenderer()->GetRow(),
            playerRemainList.at(0)->GetSpriteRenderer()->GetColumn() - 1);
        character[i] = -1;
        ...
        for (int j = 0; j < playerIconList.size(); j++) {
          if (playerIconList.at(j)->getNumOwner() == i) {
            PlayerIconSmall->GetSpriteRenderer()->ShiftTo(
                PlayerIconSmall->GetSpriteRenderer()->GetRow(),
                playerIconList.at(j)->GetSpriteRenderer()->GetColumn());
...
void LevelSelectAbility::UpdateUi() {
  ...
  for (int i = 0; i < 4; i++) {
    ...
    for (int j = 0; j < playerHoverList.size(); j++) {
      if (playerHoverWhere[i] == playerHoverWhere[j] && i != j &&
          playerHoverList.size() > 1) {
        playerHoverList.at(j)->SetPosition(glm::vec3(
            configs.at(4)->posX,
            configs.at(4)->posY + (configs.at(4)->offSetY * count), 0));
        count++;
        if (playerHoverList.at(i)->getPos() ==
            playerHoverList.at(j)->getPos()) {
          playerHoverList.at(j)->SetPosition(glm::vec3(
              configs.at(4)->posX,
              configs.at(4)->posY + (configs.at(4)->offSetY * count), 0));
        }
  ...
  for (int i = 0; i < playerAbilityList.size(); i++) {
    for (int j = 0; j < 3; j++) {
      playerAbilityList[i]->at(j)->GetSpriteRenderer()->ShiftTo(
          playerAbilityList[i]->at(j)->GetSpriteRenderer()->GetRow(),
          playerAbility[i][j]);
    }
  }
  ...
  for (int i = 0; i < playerWindowList.size(); i++) {
    ...
    playerWindowList.at(i)->SetPosition(
        glm::vec3(configs.at(0)->posX + (configs.at(0)->offSetX * axisX),
                  configs.at(0)->posY + (configs.at(0)->offSetY * axisY), 0));
    playerWindowList.at(i)->SetSize(configs.at(0)->width,
                                    -configs.at(0)->height);
    axisX++;
  }

  // Player remain
  objectsList.at(5)->SetPosition(
      glm::vec3(configs.at(1)->posX, configs.at(1)->posY, 0));
  ...
  for (int i = 0; i < AbilityIconListTop.size(); i++) {
    AbilityIconListTop.at(i)->SetPosition(
        glm::vec3(configs.at(2)->posX + (configs.at(2)->offSetX * axisX),
                  configs.at(2)->posY, 0));
    AbilityIconListTop.at(i)->SetSize(configs.at(2)->width,
                                      -configs.at(2)->height);
    axisX++;
  }
  // Down
  ...
  for (int i = 0; i < AbilityIconListDown.size(); i++) {
    AbilityIconListDown.at(i)->SetPosition(
        glm::vec3(configs.at(3)->posX + (configs.at(3)->offSetX * axisX),
                  configs.at(3)->posY, 0));
    AbilityIconListDown.at(i)->SetSize(configs.at(3)->width,
                                       -configs.at(3)->height);
    axisX++;
  }
  ...
  /*for (int i = 0; i < playerHoverList.size(); i++) {
          playerHoverList.at(i)->SetPosition(glm::vec3(configs.at(4)->posX +
  (configs.at(4)->offSetX * i), configs.at(4)->posY + (configs.at(4)->offSetY *
  i), 0)); playerHoverList.at(i)->SetSize(configs.at(4)->width,
  -configs.at(4)->height); axisX++;
  }*/
  ...
  for (int i = 0; i < playerIconList.size(); i++) {
          playerIconList.at(i)->SetSize(configs.at(5)->width,
  -configs.at(5)->height); if (i == 2) { axisX = 0; axisY = -1;
          }
          playerIconList.at(i)->SetPosition(glm::vec3(configs.at(5)->posX +
  (configs.at(5)->offSetX * axisX), configs.at(5)->posY +
  (configs.at(5)->offSetY * axisY), 0)); axisX++;
  }*/
  ...
  for (int i = 0; i < playerIconSmallList.size(); i++) {
          ...
          playerIconSmallList.at(i)->SetPosition(glm::vec3(configs.at(6)->posX +
  (configs.at(6)->offSetX * axisX), configs.at(6)->posY +
  (configs.at(6)->offSetY * axisY), 0)); axisX++;
          playerIconSmallList.at(i)->SetSize(configs.at(6)->width,
  -configs.at(6)->height);
  }*/
  ...
  for (int i = 0; i < 4; i++) {
          for (int j = 0; j < 3; j++) {
                  if (axisX < 3) {
                          playerAbilityList[i]->at(j)->SetSize(configs.at(7)->width,
  -configs.at(7)->height);
                          playerAbilityList[i]->at(j)->SetPosition(glm::vec3(configs.at(7)->posX
  + (configs.at(7)->offSetX * axisX), configs.at(7)->posY +
  (configs.at(7)->offSetY * axisY), 0));
                  }
                  else{
  ...
  if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags)) {
    ...
    if (ImGui::BeginTabItem("Config Player Window")) {
        ...
        for (int i = 0; i < playerWindowList.size(); i++) {
          ...
          playerWindowList.at(i)->SetPosition(
              glm::vec3(configs.at(configNum)->posX +
                            (configs.at(configNum)->offSetX * axisX),
                        configs.at(configNum)->posY +
                            (configs.at(configNum)->offSetY * axisY),
                        0));
          playerWindowList.at(i)->SetSize(configs.at(configNum)->width,
                                          -configs.at(configNum)->height);
          axisX++;
        }
      }
      ...
      ImGui::InputFloat("OffSetY", &configs.at(configNum)->offSetY, 1.0f, 1.0f,
                        "%.2f");
      ImGui::InputFloat("Width", &configs.at(configNum)->width, 1.0f, 1.0f,
                        "%.2f");
      ImGui::InputFloat("Height", &configs.at(configNum)->height, 1.0f, 1.0f,
                        "%.2f");
      ImGui::EndTabItem();
    }
    ...
    if (ImGui::BeginTabItem("Config Player remain")) {
      ...
      if (ImGui::Button("Load config")) {
        std::string fileName = "ConfigLevelSelectAbility1.json";
        loadConfig(fileName);
        objectsList.at(5)->SetPosition(glm::vec3(
            configs.at(configNum)->posX, configs.at(configNum)->posY, 0));
        objectsList.at(5)->SetSize(configs.at(configNum)->width,
                                   -configs.at(configNum)->height);
      }
      ImGui::InputFloat("PosX", &configs.at(configNum)->posX, 1.0f, 1.0f,
                        "%.2f");
    ...
    if (ImGui::BeginTabItem("Config Ability top")) {
      ...
      if (ImGui::Button("Load config")) {
        ...
        for (int i = 0; i < AbilityIconListTop.size(); i++) {
          ...
          AbilityIconListTop.at(i)->SetSize(configs.at(configNum)->width,
                                            -configs.at(configNum)->height);
          axisX++;
        }
      }
        ...
        for (int i = 0; i < AbilityIconListDown.size(); i++) {
          AbilityIconListDown.at(i)->SetPosition(
              glm::vec3(configs.at(configNum)->posX +
                            (configs.at(configNum)->offSetX * axisX),
                        configs.at(configNum)->posY, 0));
          AbilityIconListDown.at(i)->SetSize(configs.at(configNum)->width,
                                             -configs.at(configNum)->height);
          axisX++;
        }
      }
...
void LevelSelectAbility::Movement(float axisX, float axisY, bool isPositiveX,
                                  bool isPositiveY) {}
