...
GameEngine::GameEngine() { renderer = nullptr; }
...
GLRenderer *GameEngine::GetRenderer() { return this->renderer; }

GameStateController *GameEngine::GetStateController() {
  return this->stateController;
}

SDL_Window *GameEngine::GetSDLWindow() { return this->window; }
SDL_GLContext GameEngine::GetglContext() { return this->glContext; }

void GameEngine::SetSDLWindow(SDL_Window *window) { this->window = window; }
...
void GameEngine::Init(int width, int height) {
  ...
  renderer->InitGL("../Resource/Shader/vertext.shd",
                   "../Resource/Shader/fragment.shd");
  SetDrawArea(-3, 3, -3, 3);
...
void GameEngine::ClearMesh() { renderer->ClearMesh(); }

int GameEngine::GetWindowWidth() { return winWidth; }

int GameEngine::GetWindowHeight() { return winHeight; }
