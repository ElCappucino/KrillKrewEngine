...
void LevelWinMatch::LevelLoad()
{
    ...
    spriteList["WinMatch_BG_Char1"] =
        SpritesheetInfo("WinMatch_BG_Char1", "../Resource/Texture/GameWin/UI_GW_Char1.png", 1920, 1080, 1920, 1080);
    spriteList["WinMatch_BG_Char2"] =
        SpritesheetInfo("WinMatch_BG_Char2", "../Resource/Texture/GameWin/UI_GW_Char2.png", 1920, 1080, 1920, 1080);
    spriteList["WinMatch_BG_Char3"] =
        SpritesheetInfo("WinMatch_BG_Char3", "../Resource/Texture/GameWin/UI_GW_Char3.png", 1920, 1080, 1920, 1080);
    spriteList["WinMatch_BG_Char4"] =
        SpritesheetInfo("WinMatch_BG_Char4", "../Resource/Texture/GameWin/UI_GW_Char4.png", 1920, 1080, 1920, 1080);

    spriteList["WinMatch_PlayerNum"] =
        SpritesheetInfo("WinMatch_PlayerNum", "../Resource/Texture/GameWin/UI_GW_PlayerNum.png", 820, 175, 3280, 175);
}
...
void LevelWinMatch::LevelInit()
{
    ...
    // PlayerNum_size = glm::vec3(PlayerNum_UI->GetSpriteRenderer()->GetSpriteWidth(), PlayerNum_UI->GetSpriteRenderer()->GetSpriteHeight(),
    // 0);
...
void LevelWinMatch::UpdateUI()
{
    ...
    Background_UI->SetSize(Background_size.x * windowWidth / 1920.f, Background_size.y * windowHeight / 1080.f);

    PlayerNum_UI->SetPosition(PlayerNum_pos);
    PlayerNum_UI->SetSize(PlayerNum_size.x * windowWidth / 1920.f, PlayerNum_size.y * windowHeight / 1080.f);
}
