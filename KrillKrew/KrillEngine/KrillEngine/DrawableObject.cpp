...
void DrawableObject::SetPosition(glm::vec3 newPosition) { pos = newPosition; }
void DrawableObject::SetRotation(float degree) { rotateAngle = degree; }
...
glm::vec3 DrawableObject::getPos() { return pos; }

glm::vec3 DrawableObject::getSize() { return size; }
float DrawableObject::getOrderingLayer() const { return orderingLayer; }
bool DrawableObject::GetIsActive() { return isActive; }
void DrawableObject::SetIsActive(bool isActive) { this->isActive = isActive; }