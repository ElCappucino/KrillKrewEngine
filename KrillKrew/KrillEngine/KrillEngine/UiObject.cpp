...
UiObject::UiObject() {
  SpritesheetInfo placeholder("Xoey_UI", "../Resource/Texture/xoey.png", 430,
                              220, 430, 220);
...
void UiObject::SetIsRender(bool isRender) { this->isRender = isRender; }
bool UiObject::GetIsRender() const { return this->isRender; }
...
void UiObject::setNumOwner(int num) { playerNumOwner = num; }

int UiObject::getNumOwner() { return playerNumOwner; }
