...
#pragma clang diagnostic ignored "-Wnested-anon-types"
  ...
  union {
    ...
    /*
    #				if GLM_SWIZZLE == GLM_SWIZZLE_ENABLED
                                            _GLM_SWIZZLE1_2_MEMBERS(T, P, tvec2,
    x) _GLM_SWIZZLE1_2_MEMBERS(T, P, tvec2, r) _GLM_SWIZZLE1_2_MEMBERS(T, P,
    tvec2, s) _GLM_SWIZZLE1_3_MEMBERS(T, P, tvec3, x) _GLM_SWIZZLE1_3_MEMBERS(T,
    P, tvec3, r) _GLM_SWIZZLE1_3_MEMBERS(T, P, tvec3, s)
                                            _GLM_SWIZZLE1_4_MEMBERS(T, P, tvec4,
    x) _GLM_SWIZZLE1_4_MEMBERS(T, P, tvec4, r) _GLM_SWIZZLE1_4_MEMBERS(T, P,
...
tvec2, tvec3, tvec4) #			endif//GLM_SWIZZLE*/
  ...
  tvec1(detail::_swizzle<1, T, P, tvec1, E0, -1,-2,-3> const & that)
                          {
                                  *this = that();
                          }
  ...
  */
  ...
  template <typename U> GLM_FUNC_DECL tvec1<T, P> &operator+=(U scalar);
  template <typename U>
  GLM_FUNC_DECL tvec1<T, P> &operator+=(tvec1<U, P> const &v);
  template <typename U> GLM_FUNC_DECL tvec1<T, P> &operator-=(U scalar);
  template <typename U>
...
GLM_FUNC_DECL tvec1<bool, P> operator&&(tvec1<bool, P> const &v1,
