...
/* Only enable HIDAPI support if you want to support Steam Controllers on iOS
 * and tvOS */
 ...
 */
#if (TARGET_OS_SIMULATOR && ((__IPHONE_OS_VERSION_MIN_REQUIRED >= 130000) ||   \
                             (__TV_OS_VERSION_MIN_REQUIRED >= 130000))) ||     \
    (!TARGET_CPU_ARM && ((__IPHONE_OS_VERSION_MIN_REQUIRED >= 80000) ||        \
                         (__TV_OS_VERSION_MIN_REQUIRED >= 90000)))
