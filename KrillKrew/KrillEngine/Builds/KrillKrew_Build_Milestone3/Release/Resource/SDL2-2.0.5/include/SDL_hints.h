 ...
 * controllers. This will override SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES and the
 ...
 * controllers. This will override SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES and the
 * built in device list.
 *
 *  The format of the string is a comma separated list of USB VID/PID pairs
 *  in hexadecimal form, e.g.
 ...
 * factor. This will override SDL_HINT_JOYSTICK_GAMECUBE_DEVICES and the built
 * in device list.
 *
 *  The format of the string is a comma separated list of USB VID/PID pairs
 *  in hexadecimal form, e.g.
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for the Steam Deck
 ...
 * controllers. This will override SDL_HINT_JOYSTICK_THROTTLE_DEVICES and the
 * built in device list.
 *
 *  The format of the string is a comma separated list of USB VID/PID pairs
 *  in hexadecimal form, e.g.
 ...
 * controllers. This will override SDL_HINT_JOYSTICK_WHEEL_DEVICES and the built
 * in device list.
 *
 *  The format of the string is a comma separated list of USB VID/PID pairs
 *  in hexadecimal form, e.g.
 ...
 *
 *  The level can be a numeric level, one of "verbose", "debug", "info", "warn",
 * "error", "critical", or "quiet" to disable that category.
 *
...
/**
 *  \brief  A variable controlling whether the hardware cursor stays visible
 * when relative mode is active.
 *
 *  This variable can be set to the following values:
 *    "0"       - The cursor will be hidden while relative mode is active
 * (default) "1"       - The cursor will remain visible while relative mode is
 * active
 *
 ...
 * mice. This will override SDL_HINT_ROG_GAMEPAD_MICE and the built in device
 * list.
 *
 *  The format of the string is a comma separated list of USB VID/PID pairs
 *  in hexadecimal form, e.g.
 ...
 *            seeing if "true" causes more problems than it solves in modern
 * times.
 *
 */
 ...
 * Windows Settings charm. SDL provides code to add a link there, with its label
 * text being set via the optional hint, SDL_HINT_WINRT_PRIVACY_POLICY_LABEL.
 *
