...
#pragma once
    ...
    defined(GLM_FORCE_UNRESTRICTED_GENTYPE)
#error                                                                         \
...
#define GLM_HAS_CONSTEXPR                                                      \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                         \
   (((GLM_COMPILER & GLM_COMPILER_VC) &&                                       \
    ...
    ((GLM_COMPILER & GLM_COMPILER_GCC) &&                                      \
     (GLM_COMPILER >=                                                          \
      GLM_COMPILER_GCC48)))) // GCC 4.6 support constexpr but there is a
                             // compiler bug causing a crash
  ...
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                         \
   (((GLM_COMPILER & GLM_COMPILER_GCC)) ||                                     \
    ((GLM_COMPILER & GLM_COMPILER_VC) &&                                       \
     (GLM_COMPILER >= GLM_COMPILER_VC12)) ||                                   \
    ((GLM_COMPILER & GLM_COMPILER_INTEL) &&                                    \
     (GLM_COMPILER >= GLM_COMPILER_INTEL12)) ||                                \
    (GLM_COMPILER & GLM_COMPILER_CUDA)))
#endif
  ...
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                         \
   (((GLM_COMPILER & GLM_COMPILER_GCC)) ||                                     \
    ((GLM_COMPILER & GLM_COMPILER_VC) &&                                       \
     (GLM_COMPILER >= GLM_COMPILER_VC11)) ||                                   \
    ((GLM_COMPILER & GLM_COMPILER_CUDA) &&                                     \
     (GLM_COMPILER >= GLM_COMPILER_CUDA50))))
#endif
...
#define GLM_HAS_EXPLICIT_CONVERSION_OPERATORS                                  \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                         \
   (((GLM_COMPILER & GLM_COMPILER_GCC) &&                                      \
     (GLM_COMPILER >= GLM_COMPILER_GCC45)) ||                                  \
    ((GLM_COMPILER & GLM_COMPILER_INTEL) &&                                    \
...
#define GLM_HAS_TEMPLATE_ALIASES                                               \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                         \
   (((GLM_COMPILER & GLM_COMPILER_INTEL) &&                                    \
     (GLM_COMPILER >= GLM_COMPILER_INTEL12_1)) ||                              \
    ((GLM_COMPILER & GLM_COMPILER_GCC) &&                                      \
...
#define GLM_HAS_RANGE_FOR                                                      \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                         \
   (((GLM_COMPILER & GLM_COMPILER_GCC) &&                                      \
     (GLM_COMPILER >= GLM_COMPILER_GCC46)) ||                                  \
    ((GLM_COMPILER & GLM_COMPILER_INTEL) &&                                    \
     (GLM_COMPILER >= GLM_COMPILER_INTEL13)) ||                                \
    ((GLM_COMPILER & GLM_COMPILER_VC) &&                                       \
     (GLM_COMPILER >= GLM_COMPILER_VC11)) ||                                   \
    ((GLM_COMPILER & GLM_COMPILER_CUDA) &&                                     \
     (GLM_COMPILER >= GLM_COMPILER_CUDA50))))
