...
#pragma clang diagnostic ignored "-Wnested-anon-types"
  ...
  union {
    ...
    typename detail::storage<T, sizeof(T) * 4,
...
#pragma GCC diagnostic pop
  ...
  template <typename A, typename B, typename C, typename D>
  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec4(tvec1<A, P> const &a,
                                         tvec1<B, P> const &b,
                                         tvec1<C, P> const &c,
                                         tvec1<D, P> const &d);
  ...
  /// constructors of GLSL 1.30.08 specification)
  template <typename A, typename B, typename C, precision Q>
  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec4(tvec2<A, Q> const &a,
                                         tvec1<B, Q> const &b,
                                         tvec1<C, Q> const &c);
  /// Explicit conversions (From section 5.4.1 Conversion and scalar
  /// constructors of GLSL 1.30.08 specification)
  ...
  /// constructors of GLSL 1.30.08 specification)
  template <typename A, typename B, typename C, precision Q>
  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec4(tvec1<A, Q> const &a,
                                         tvec2<B, Q> const &b,
                                         tvec1<C, Q> const &c);
  /// Explicit conversions (From section 5.4.1 Conversion and scalar
  /// constructors of GLSL 1.30.08 specification)
  ...
  /// constructors of GLSL 1.30.08 specification)
  template <typename A, typename B, precision Q>
  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec4(tvec3<A, Q> const &a,
                                         tvec1<B, Q> const &b);
  /// Explicit conversions (From section 5.4.1 Conversion and scalar
  /// constructors of GLSL 1.30.08 specification)
  template <typename A, typename B, precision Q>
  ...
  GLM_FUNC_DECL
  tvec4(detail::_swizzle<4, T, P, glm::tvec4, E0, E1, E2, E3> const &that) {
    *this = that();
  }

  template <int E0, int E1, int F0, int F1>
  GLM_FUNC_DECL
  tvec4(detail::_swizzle<2, T, P, glm::tvec2, E0, E1, -1, -2> const &v,
        detail::_swizzle<2, T, P, glm::tvec2, F0, F1, -1, -2> const &u) {
    *this = tvec4<T, P>(v(), u());
  }

  template <int E0, int E1>
  GLM_FUNC_DECL
  tvec4(T const &x, T const &y,
        detail::_swizzle<2, T, P, glm::tvec2, E0, E1, -1, -2> const &v) {
  ...
  GLM_FUNC_DECL
  tvec4(detail::_swizzle<3, T, P, glm::tvec3, E0, E1, E2, -1> const &v,
        T const &w) {
    *this = tvec4<T, P>(v(), w);
  }
  ...
  GLM_FUNC_DECL
  tvec4(T const &x,
        detail::_swizzle<3, T, P, glm::tvec3, E0, E1, E2, -1> const &v) {
    *this = tvec4<T, P>(x, v());
  }
  ...
  template <typename U> GLM_FUNC_DECL tvec4<T, P> &operator+=(U scalar);
  template <typename U>
...
template <typename T, precision P>
GLM_FUNC_DECL tvec4<T, P> operator+(tvec1<T, P> const &v1,
                                    tvec4<T, P> const &v2);
...
template <typename T, precision P>
GLM_FUNC_DECL tvec4<T, P> operator%(tvec1<T, P> const &scalar,
                                    tvec4<T, P> const &v);
...
GLM_FUNC_DECL tvec4<bool, P> operator&&(tvec4<bool, P> const &v1,
