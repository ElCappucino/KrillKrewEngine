...
GLM_FUNC_QUALIFIER tvec2<T, P> lerp(const tvec2<T, P> &x, const tvec2<T, P> &y,
                                    T a) {
  return mix(x, y, a);
} //!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y
  //!< using the floating-point value a. The value for a is not restricted to
...
template <typename T, precision P>
GLM_FUNC_QUALIFIER tvec3<T, P> lerp(const tvec3<T, P> &x, const tvec3<T, P> &y,
                                    T a) {
  return mix(x, y, a);
} //!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y
  //!< using the floating-point value a. The value for a is not restricted to
  //!< the range [0, 1]. (From GLM_GTX_compatibility)
template <typename T, precision P>
GLM_FUNC_QUALIFIER tvec4<T, P> lerp(const tvec4<T, P> &x, const tvec4<T, P> &y,
                                    T a) {
  return mix(x, y, a);
} //!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y
  //!< using the floating-point value a. The value for a is not restricted to
...
template <typename T, precision P>
GLM_FUNC_QUALIFIER tvec2<T, P> atan2(const tvec2<T, P> &x,
                                     const tvec2<T, P> &y) {
  return atan(x, y);
} //!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x
  //!< and y are used to determine what quadrant the angle is in. The range of
  ...
  //!< and y are both 0. (From GLM_GTX_compatibility)
template <typename T, precision P>
GLM_FUNC_QUALIFIER tvec3<T, P> atan2(const tvec3<T, P> &x,
                                     const tvec3<T, P> &y) {
  return atan(x, y);
} //!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x
  //!< and y are used to determine what quadrant the angle is in. The range of
  ...
  //!< and y are both 0. (From GLM_GTX_compatibility)
template <typename T, precision P>
GLM_FUNC_QUALIFIER tvec4<T, P> atan2(const tvec4<T, P> &x,
                                     const tvec4<T, P> &y) {
  return atan(x, y);
} //!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x
  //!< and y are used to determine what quadrant the angle is in. The range of
...
template <typename T, precision P>
GLM_FUNC_DECL tvec1<bool, P>
isfinite(const tvec1<T, P>
             &x); //!< \brief Test whether or not a scalar or each vector
                  //!< component is a finite value. (From GLM_GTX_compatibility)
template <typename T, precision P>
GLM_FUNC_DECL tvec2<bool, P>
isfinite(const tvec2<T, P>
             &x); //!< \brief Test whether or not a scalar or each vector
                  //!< component is a finite value. (From GLM_GTX_compatibility)
template <typename T, precision P>
GLM_FUNC_DECL tvec3<bool, P>
isfinite(const tvec3<T, P>
             &x); //!< \brief Test whether or not a scalar or each vector
                  //!< component is a finite value. (From GLM_GTX_compatibility)
template <typename T, precision P>
GLM_FUNC_DECL tvec4<bool, P>
isfinite(const tvec4<T, P>
             &x); //!< \brief Test whether or not a scalar or each vector
                  //!< component is a finite value. (From GLM_GTX_compatibility)

typedef bool bool1; //!< \brief boolean type with 1 component. (From
                    //!< GLM_GTX_compatibility extension)
typedef tvec2<bool, highp> bool2; //!< \brief boolean type with 2 components.
                                  //!< (From GLM_GTX_compatibility extension)
typedef tvec3<bool, highp> bool3; //!< \brief boolean type with 3 components.
                                  //!< (From GLM_GTX_compatibility extension)
typedef tvec4<bool, highp> bool4; //!< \brief boolean type with 4 components.
                                  //!< (From GLM_GTX_compatibility extension)
...
typedef int int1; //!< \brief integer vector with 1 component. (From
                  //!< GLM_GTX_compatibility extension)
typedef tvec2<int, highp> int2; //!< \brief integer vector with 2 components.
                                //!< (From GLM_GTX_compatibility extension)
typedef tvec3<int, highp> int3; //!< \brief integer vector with 3 components.
                                //!< (From GLM_GTX_compatibility extension)
typedef tvec4<int, highp> int4; //!< \brief integer vector with 4 components.
                                //!< (From GLM_GTX_compatibility extension)
