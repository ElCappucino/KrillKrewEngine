...
typedef enum {
  ...
  SDL_BLENDOPERATION_SUBTRACT =
      0x2, /**< dst - src : supported by D3D9, D3D11, OpenGL, OpenGLES */
  SDL_BLENDOPERATION_REV_SUBTRACT =
      0x3, /**< src - dst : supported by D3D9, D3D11, OpenGL, OpenGLES */
...
/**
 *  \brief Create a custom blend mode, which may or may not be supported by a
 * given renderer
 *
