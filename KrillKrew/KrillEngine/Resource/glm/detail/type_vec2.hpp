...
#pragma GCC diagnostic pop
  ...
  template <typename A, typename B>
  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec2(tvec1<A, P> const &v1,
                                         tvec1<B, P> const &v2);
  ...
  GLM_FUNC_DECL
  tvec2(detail::_swizzle<2, T, P, glm::tvec2, E0, E1, -1, -2> const &that) {
    *this = that();
  }
  ...
  template <typename U> GLM_FUNC_DECL tvec2<T, P> &operator+=(U scalar);
  template <typename U>
...
template <typename T, precision P>
GLM_FUNC_DECL tvec2<T, P> operator+(tvec1<T, P> const &v1,
                                    tvec2<T, P> const &v2);
...
GLM_FUNC_DECL tvec2<bool, P> operator&&(tvec2<bool, P> const &v1,
