...
#pragma GCC diagnostic pop
  ...
  template <typename A, typename B, typename C>
  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec3(tvec1<A, P> const &a,
                                         tvec1<B, P> const &b,
                                         tvec1<C, P> const &c);
  ...
  /// constructors of GLSL 1.30.08 specification)
  template <typename A, typename B, precision Q>
  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec3(tvec2<A, Q> const &a,
                                         tvec1<B, Q> const &b);
  /// Explicit conversions (From section 5.4.1 Conversion and scalar
  /// constructors of GLSL 1.30.08 specification)
  template <typename A, typename B, precision Q>
  ...
  /// constructors of GLSL 1.30.08 specification)
  template <typename A, typename B, precision Q>
  GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec3(tvec1<A, Q> const &a,
                                         tvec2<B, Q> const &b);
  /// Explicit conversions (From section 5.4.1 Conversion and scalar
  /// constructors of GLSL 1.30.08 specification)
  ...
  GLM_FUNC_DECL
  tvec3(detail::_swizzle<3, T, P, glm::tvec3, E0, E1, E2, -1> const &that) {
    *this = that();
  }

  template <int E0, int E1>
  GLM_FUNC_DECL
  tvec3(detail::_swizzle<2, T, P, glm::tvec2, E0, E1, -1, -2> const &v,
        T const &scalar) {
  ...
  template <typename U> GLM_FUNC_DECL tvec3<T, P> &operator+=(U scalar);
  template <typename U>
...
template <typename T, precision P>
GLM_FUNC_DECL tvec3<T, P> operator+(tvec1<T, P> const &v1,
                                    tvec3<T, P> const &v2);
...
GLM_FUNC_DECL tvec3<bool, P> operator&&(tvec3<bool, P> const &v1,
