...
GLM_FUNC_DECL vecType<uint, P> uaddCarry(vecType<uint, P> const &x,
...
/// specification, section 8.8 Integer Functions</a>
template <precision P, template <typename, precision> class vecType>
GLM_FUNC_DECL vecType<uint, P> usubBorrow(vecType<uint, P> const &x,
                                          vecType<uint, P> const &y,
...
/// specification, section 8.8 Integer Functions</a>
template <precision P, template <typename, precision> class vecType>
GLM_FUNC_DECL void umulExtended(vecType<uint, P> const &x,
                                vecType<uint, P> const &y,
                                vecType<uint, P> &msb, vecType<uint, P> &lsb);
...
/// specification, section 8.8 Integer Functions</a>
template <precision P, template <typename, precision> class vecType>
GLM_FUNC_DECL void imulExtended(vecType<int, P> const &x,
                                vecType<int, P> const &y, vecType<int, P> &msb,
                                vecType<int, P> &lsb);
...
GLM_FUNC_DECL vecType<T, P> bitfieldExtract(vecType<T, P> const &Value,
                                            int Offset, int Bits);
...
/// specification, section 8.8 Integer Functions</a>
template <typename T, precision P, template <typename, precision> class vecType>
GLM_FUNC_DECL vecType<T, P> bitfieldInsert(vecType<T, P> const &Base,
...
/// href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8
/// specification, section 8.8 Integer Functions</a>
template <typename genType> GLM_FUNC_DECL int bitCount(genType v);
...
/// href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8
/// specification, section 8.8 Integer Functions</a>
template <typename genIUType> GLM_FUNC_DECL int findLSB(genIUType x);
...
/// href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8
/// specification, section 8.8 Integer Functions</a>
template <typename genIUType> GLM_FUNC_DECL int findMSB(genIUType x);
